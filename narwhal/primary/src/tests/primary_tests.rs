...
async fn test_get_network_peers_from_admin_server() {
    ...
    let (tx_new_certificates, _rx_new_certificates) = mango_metrics::metered_channel::channel(
        CHANNEL_CAPACITY,
    ...
    let (tx_feedback, rx_feedback) = mango_metrics::metered_channel::channel(
        CHANNEL_CAPACITY,
        &prometheus::IntGauge::new(
    ...
    let (tx_new_certificates_2, _rx_new_certificates_2) = mango_metrics::metered_channel::channel(
        CHANNEL_CAPACITY,
        &prometheus::IntGauge::new(
            PrimaryChannelMetrics::NAME_NEW_CERTS,
            PrimaryChannelMetrics::DESC_NEW_CERTS,
    ...
    let (tx_feedback_2, rx_feedback_2) = mango_metrics::metered_channel::channel(
        CHANNEL_CAPACITY,
        &prometheus::IntGauge::new(
            PrimaryChannelMetrics::NAME_COMMITTED_CERTS,
            PrimaryChannelMetrics::DESC_COMMITTED_CERTS,
