...
pub use mango_metrics::start_prometheus_server;
...
/// #[tokio::main]
/// async fn main() {
///      let prometheus_registry = mango_service::metrics::start_basic_prometheus_server();
...
pub fn start_basic_prometheus_server() -> Registry {
    ...
    mango_metrics::start_prometheus_server(addr).default_registry()
}
