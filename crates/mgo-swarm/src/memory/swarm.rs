...
use mgo_swarm_config::genesis_config::{AccountConfig, GenesisConfig, ValidatorGenesisConfig};
...
/// A handle to an in-memory Mgo Network.
#[derive(Debug)]
pub struct Swarm {
    dir: SwarmDirectory,
...
impl Swarm {
    ...
    pub fn validator_node_handles(&self) -> Vec<MgoNodeHandle> {
    ...
    pub async fn spawn_new_node(&mut self, config: NodeConfig) -> MgoNodeHandle {
