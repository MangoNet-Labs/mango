...
use mgo_storage::{compute_sha3_checksum, FileCompression, SHA3_BYTES};
...
/// The following describes the format of an object file (*.obj) used for persisting live mgo objects.
