...
use mgo_storage::blob::{Blob, BlobEncoding, BLOB_ENCODING_BYTES};
use mgo_storage::object_store::util::{copy_file, delete_recursively, path_to_filesystem};
...
impl StateSnapshotWriterV1 {
    ...
    pub async fn write(
        ...
        let system_state_object = get_mgo_system_state(&perpetual_db)?;
