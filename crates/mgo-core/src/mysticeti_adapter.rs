...
impl MysticetiClient {
    ...
    async fn submit_transaction(&self, transaction: &ConsensusTransaction) -> MgoResult {
...
impl LazyMysticetiClient {
    ...
    async fn get(&self) -> Guard<Option<Arc<MysticetiClient>>> {
        ...
        // We expect this to get called during the MGO process start. After that at least one
