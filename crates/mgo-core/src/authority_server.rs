...
use mango_metrics::histogram::Histogram as MangoHistogram;
...
use mgo_types::messages_consensus::ConsensusTransaction;
...
use mgo_types::{effects::TransactionEffectsAPI, message_envelope::Message};
use mgo_types::{error::*, transaction::*};
use mgo_types::{
    fp_ensure,
    messages_checkpoint::{
...
impl AuthorityServer {
    ...
    pub async fn spawn_with_bind_address_for_test(
        ...
        let mut server = mango_network::config::Config::new()
            .server_builder()
...
pub struct ValidatorServiceMetrics {
    ...
    pub tx_verification_latency: MangoHistogram,
    pub cert_verification_latency: MangoHistogram,
    pub consensus_latency: MangoHistogram,
    pub handle_transaction_latency: MangoHistogram,
    pub submit_certificate_consensus_latency: MangoHistogram,
    pub handle_certificate_consensus_latency: MangoHistogram,
    pub handle_certificate_non_consensus_latency: MangoHistogram,
...
impl ValidatorService {
    ...
    async fn handle_transaction(
        ...
        let info = state
            ...
            .await
            .tap_err(|e| {
                if let MgoError::ValidatorHaltedAtEpochEnd = e {
    ...
    async fn handle_certificate(
        ...
        let certificate = {
            ...
            if !reconfiguration_lock.should_accept_user_certs() {
                ...
                return Err(MgoError::ValidatorHaltedAtEpochEnd.into());
            }
...
impl Validator for ValidatorService {
    ...
    ) -> Result<tonic::Response<MgoSystemState>, tonic::Status> {
        let response = self.state.database.get_mgo_system_state_object_unsafe()?;
