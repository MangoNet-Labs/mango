...
use mgo_types::base_types::{ObjectID, ObjectRef, SequenceNumber, VersionNumber};
...
use mgo_types::messages_checkpoint::{CheckpointSequenceNumber, ECMHLiveObjectSetDigest};
...
impl StateAccumulator {
    ...
    pub async fn digest_epoch(
        ...
        last_checkpoint_of_epoch: CheckpointSequenceNumber,
        epoch_store: Arc<AuthorityPerEpochStore>,
    ) -> MgoResult<ECMHLiveObjectSetDigest> {
        Ok(self
