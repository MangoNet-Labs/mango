...
use mgo_types::base_types::{ObjectDigest, SequenceNumber, TransactionDigest};
use mgo_types::coin::Coin;
use mgo_types::crypto::{default_hash, Signable};
use mgo_types::error::MgoError;
use mgo_types::move_package::MovePackage;
use mgo_types::object::{Data, MoveObject, Object, ObjectInner, Owner};
...
/// Forked version of [`mgo_types::object::Object`]
...
/// Forked version of [`mgo_types::object::Data`]
