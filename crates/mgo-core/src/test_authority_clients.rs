...
impl AuthorityAPI for LocalAuthorityClient {
    async fn handle_transaction(
        ...
        if self.fault_config.fail_before_handle_transaction {
            return Err(MgoError::from("Mock error before handle_transaction"));
        }
    ...
    async fn handle_system_state_object(
        ...
        self.state.get_mgo_system_state_object_for_testing()
    }
}
...
pub struct MockAuthorityApi {
    delay: Duration,
    count: Arc<Mutex<u32>>,
    handle_object_info_request_result: Option<MgoResult<ObjectInfoResponse>>,
}
...
impl MockAuthorityApi {
    ...
    pub fn set_handle_object_info_request(&mut self, result: MgoResult<ObjectInfoResponse>) {
...
impl AuthorityAPI for MockAuthorityApi {
    ...
    async fn handle_transaction_info_request(
        ...
        Err(MgoError::TransactionNotFound {
...
pub struct HandleTransactionTestAuthorityClient {
    pub tx_info_resp_to_return: MgoResult<HandleTransactionResponse>,
    pub cert_resp_to_return: MgoResult<HandleCertificateResponseV2>,
...
impl HandleTransactionTestAuthorityClient {
    pub fn new() -> Self {
        Self {
            tx_info_resp_to_return: Err(MgoError::Unknown("".to_string())),
            cert_resp_to_return: Err(MgoError::Unknown("".to_string())),
    ...
    pub fn set_tx_info_response_error(&mut self, error: MgoError) {
        self.tx_info_resp_to_return = Err(error);
    }

    pub fn reset_tx_info_response(&mut self) {
        self.tx_info_resp_to_return = Err(MgoError::Unknown("".to_string()));
    }
    ...
    pub fn set_cert_resp_to_return_error(&mut self, error: MgoError) {
        self.cert_resp_to_return = Err(error);
    }

    pub fn reset_cert_response(&mut self) {
        self.cert_resp_to_return = Err(MgoError::Unknown("".to_string()));
    }
