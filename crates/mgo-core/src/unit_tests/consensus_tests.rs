...
use mgo_network::tonic;
use mgo_types::crypto::deterministic_random_account_key;
use mgo_types::multiaddr::Multiaddr;
use mgo_types::transaction::TEST_ONLY_GAS_UNIT_FOR_OBJECT_BASICS;
...
impl ConsensusMockServer {
    pub fn spawn(address: Multiaddr) -> Receiver<TransactionProto> {
        ...
        tokio::spawn(async move {
            let config = mango_network::config::Config::new();
