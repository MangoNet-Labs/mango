...
pub trait FaucetClient {
    async fn request_mgo_coins(&self, request_address: MgoAddress) -> FaucetResponse;
    async fn batch_request_mgo_coins(&self, request_address: MgoAddress) -> BatchFaucetResponse;
...
impl FaucetClient for RemoteFaucetClient {
    /// Request test MGO coins from faucet.
