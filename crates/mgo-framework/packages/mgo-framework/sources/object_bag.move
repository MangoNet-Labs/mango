...
/// Similar to `mgo::bag`, an `ObjectBag` is a heterogeneous map-like collection. But unlike
/// `mgo::bag`, the values bound to these dynamic fields _must_ be objects themselves. This allows
