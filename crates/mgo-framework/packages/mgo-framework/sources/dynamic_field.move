...
#[allow(unused_const)]
/// In addition to the fields declared in its type definition, a Mgo object can have dynamic fields
...
/// This gives Mgo programmers the flexibility to extend objects on-the-fly, and it also serves as a
