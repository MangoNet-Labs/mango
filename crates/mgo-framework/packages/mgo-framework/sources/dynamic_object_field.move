...
/// Similar to `mgo::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `mgo::dynamic_field` the values bound to these dynamic fields _must_ be objects
