...
module mgo::display {
    use mgo::package::{from_package, Publisher};
    ...
    /// the discovery.
    ///
    /// Since Mgo RPC supports querying events by type, finding a Display for the T
...
#[test_only]
module mgo::display_tests {
    use mgo::object::UID;
    use mgo::test_scenario as test;
    use mgo::transfer;
