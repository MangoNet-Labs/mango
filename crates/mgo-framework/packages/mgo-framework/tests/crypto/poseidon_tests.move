...
#[test_only]
module mgo::poseidon_tests {
    use mgo::poseidon::poseidon_bn254;
    ...
    #[test]
    #[expected_failure(abort_code = mgo::poseidon::ENonCanonicalInput)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::poseidon::EEmptyInput)]
