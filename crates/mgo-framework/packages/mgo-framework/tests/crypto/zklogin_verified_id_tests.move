...
#[test_only]
module mgo::zklogin_verified_id_tests {
    use mgo::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};
    use std::string::utf8;
    use mgo::test_scenario;

    #[test]
    #[expected_failure(abort_code = mgo::zklogin_verified_id::EFunctionDisabled)]
