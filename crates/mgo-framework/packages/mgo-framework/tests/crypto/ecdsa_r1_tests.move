...
#[test_only]
module mgo::ecdsa_r1_tests {
    use mgo::ecdsa_r1;
    
    #[test]
    fun test_ecrecover_pubkey() {
        // test case generated against https://github.com/MangoNetworkOs/fastcrypto/blob/285e3f238112703cdfb7eb21e0ea3100e2882e14/fastcrypto/src/tests/secp256r1_recoverable_tests.rs
