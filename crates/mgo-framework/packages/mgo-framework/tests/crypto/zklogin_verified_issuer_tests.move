...
#[test_only]
module mgo::zklogin_verified_issuer_tests {
    use mgo::zklogin_verified_issuer::{check_zklogin_issuer, delete, verify_zklogin_issuer, VerifiedIssuer};
    use std::string::utf8;
    ...
    #[test]
    #[expected_failure(abort_code = mgo::zklogin_verified_issuer::EInvalidProof)]
