...
#[test_only]
module mgo::bag_tests {
    use mgo::bag::{Self, add, contains_with_type, borrow, borrow_mut, remove};
    ...
    #[test]
    #[expected_failure(abort_code = mgo::dynamic_field::EFieldAlreadyExists)]
    fun add_duplicate() {
        let sender = @0x0;
        let scenario = ts::begin(sender);
        let bag = bag::new(ts::ctx(&mut scenario));
    ...
    #[test]
    #[expected_failure(abort_code = mgo::dynamic_field::EFieldDoesNotExist)]
    fun borrow_missing() {
        let sender = @0x0;
        let scenario = ts::begin(sender);
        let bag = bag::new(ts::ctx(&mut scenario));
    ...
    #[test]
    #[expected_failure(abort_code = mgo::dynamic_field::EFieldTypeMismatch)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::bag::EBagNotEmpty)]
