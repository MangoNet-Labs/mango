...
#[test_only]
module mgo::object_table_tests {
    use std::option;
    use mgo::object_table::{Self, add, contains, borrow, borrow_mut, remove, value_id};
    ...
    #[test]
    #[expected_failure(abort_code = mgo::object_table::ETableNotEmpty)]
