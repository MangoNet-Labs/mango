...
module mgo::kiosk_borrow_tests {
    use mgo::kiosk_test_utils::{Self as utils, Asset};
    use mgo::kiosk;
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::ENotOwner)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EItemIsListed)]
    ...
    fun test_borrow_val() {
        ...
        assert!(mgo::object::id(&item) == id, 0);
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EWrongKiosk)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EItemMismatch)]
