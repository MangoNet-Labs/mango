...
module mgo::kiosk_tests {
    use mgo::kiosk_test_utils::{Self as test, Asset};
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EItemLocked)]
    ...
    fun test_purchase() {
        ...
        let payment = coin::mint_for_testing<MGO>(AMT, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::ENotListed)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EListedExclusively)]
    ...
    #[allow(unused_field)]
    struct WrongAsset has key, store { id: mgo::object::UID }

    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EItemNotFound)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EIncorrectAmount)]
    fun test_purchase_wrong_amount() {
        ...
        kiosk::place_and_list(&mut kiosk, &owner_cap, asset, AMT);
        let payment = coin::mint_for_testing<MGO>(AMT + 1, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EAlreadyListed)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::ENotEmpty)]
    ...
    #[test]
    #[expected_failure(abort_code = mgo::kiosk::ENotEnough)]
    ...
    fun test_uid_access() {
        ...
        assert!(mgo::object::uid_to_inner(uid) == mgo::object::id(&kiosk), 0);

        test::return_kiosk(kiosk, owner_cap, ctx);
    }

    #[test]
    #[expected_failure(abort_code = mgo::kiosk::EUidAccessNotAllowed)]
