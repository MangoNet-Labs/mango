module mgo_inscription::inscription {
    ...
    use mgo::transfer::{public_share_object, public_transfer};
    use mgo::tx_context;
    use mgo::tx_context::TxContext;

    use mgo_inscription::coinscription;
    use mgo_inscription::coinscription::{CoinScription, TickPoolRecord, TickRecord};
    use mgo_inscription::singlescription;
    use mgo_inscription::singlescription::{CopyrightPoolRecord, SingleScription, SingleScriptionRecord};
