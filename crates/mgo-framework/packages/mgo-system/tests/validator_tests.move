...
#[test_only]
module mgo_system::validator_tests {
    use mgo::mgo::MGO;
    ...
    use mgo::balance;
    use mgo_system::staking_pool::{Self, StakedMgo};
    use std::vector;
    use mgo::test_utils;
    use mgo::bag;
    use mgo::transfer;
    ...
    fun test_validator_owner_flow() {
        ...
        let scenario = &mut scenario_val;
        {
            ...
            assert!(validator::mgo_address(&validator) == sender, 0);
        ...
        // Check that after destroy, the original stake still exists.
         ...
         {
             let stake = test_scenario::take_from_sender<StakedMgo>(scenario);
             assert!(staking_pool::staked_mgo_amount(&stake) == 10_000_000_000, 0);
    ...
    fun test_pending_validator_flow() {
        ...
        test_scenario::next_tx(scenario, sender);
        {
            let coin_ids = test_scenario::ids_for_sender<StakedMgo>(scenario);
            let stake = test_scenario::take_from_sender_by_id<StakedMgo>(scenario, *vector::borrow(&coin_ids, 0));
            let ctx = test_scenario::ctx(scenario);
        ...
        test_scenario::next_tx(scenario, sender);
        {
            ...
            let withdraw = test_scenario::take_from_sender_by_id<Coin<MGO>>(scenario, *vector::borrow(&coin_ids, 0));
    ...
    #[expected_failure(abort_code = mgo_system::validator::EInvalidProofOfPossession)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EMetadataInvalidNetPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EMetadataInvalidWorkerPubkey)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EMetadataInvalidNetAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EMetadataInvalidPrimaryAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EMetadataInvalidWorkerAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EMetadataInvalidP2pAddr)]
    #[test]
    ...
    #[expected_failure(abort_code = mgo_system::validator::EValidatorMetadataExceedingLengthLimit)]
    #[test]
