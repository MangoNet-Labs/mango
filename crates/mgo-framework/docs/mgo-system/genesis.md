...
<b>use</b> <a href="mgo_system.md#0x3_mgo_system">0x3::mgo_system</a>;
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_create">create</a>(mgo_system_state_id: <a href="dependencies/mgo-framework/object.md#0x2_object_UID">object::UID</a>, mgo_supply: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, genesis_chain_parameters: <a href="genesis.md#0x3_genesis_GenesisChainParameters">genesis::GenesisChainParameters</a>, genesis_validators: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x3_genesis_GenesisValidatorMetadata">genesis::GenesisValidatorMetadata</a>&gt;, token_distribution_schedule: <a href="genesis.md#0x3_genesis_TokenDistributionSchedule">genesis::TokenDistributionSchedule</a>, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_create">create</a>(
    ...
    <b>let</b> system_parameters = <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_create_system_parameters">mgo_system_state_inner::create_system_parameters</a>(
    ...
    <a href="mgo_system.md#0x3_mgo_system_create">mgo_system::create</a>(
        mgo_system_state_id,
        validators,
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(mgo_supply: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, allocations: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x3_genesis_TokenAllocation">genesis::TokenAllocation</a>&gt;, validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x3_genesis_allocate_tokens">allocate_tokens</a>(
    ...
    <b>while</b> (!<a href="dependencies/move-stdlib/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&allocations)) {
        ...
        <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&staked_with_validator)) {
            ...
            <a href="dependencies/mgo-framework/mgo.md#0x2_mgo_transfer">mgo::transfer</a>(
                <a href="dependencies/mgo-framework/coin.md#0x2_coin_from_balance">coin::from_balance</a>(allocation_balance, ctx),
                recipient_address,
            );
        };
    };
    ...
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_destroy_zero">balance::destroy_zero</a>(mgo_supply);
}
</code></pre>
