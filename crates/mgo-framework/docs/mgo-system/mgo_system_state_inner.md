...
-  [Function `update_validator_next_epoch_worker_pubkey`](#0x3_mgo_system_state_inner_update_validator_next_epoch_worker_pubkey)
...
<dd>
 ...
 This is always the same as MgoSystemState.version. Keeping a copy here so that
 we know what version it is by inspecting MgoSystemStateInner as well.
</dd>
<dt>
...
<dt>
<code>parameters: <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParameters">mgo_system_state_inner::SystemParameters</a></code>
</dt>
<dd>
 A list of system config parameters.
</dd>
...
<dt>
<code>validator_report_records: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_VecSet">vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;</code>
</dt>
<dd>
...
<dt>
<code>safe_mode_storage_rewards: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>safe_mode_computation_rewards: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>parameters: <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParametersV2">mgo_system_state_inner::SystemParametersV2</a></code>
</dt>
<dd>
 A list of system config parameters.
</dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_create">create</a>(
    validators: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;,
    initial_storage_fund: Balance&lt;MGO&gt;,
    protocol_version: u64,
    epoch_start_timestamp_ms: u64,
    parameters: <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParameters">SystemParameters</a>,
    <a href="stake_subsidy.md#0x3_stake_subsidy">stake_subsidy</a>: StakeSubsidy,
    ctx: &<b>mut</b> TxContext,
): <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInner">MgoSystemStateInner</a> {
    ...
    <b>let</b> system_state = <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInner">MgoSystemStateInner</a> {
        epoch: 0,
        protocol_version,
        system_state_version: <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_genesis_system_state_version">genesis_system_state_version</a>(),
        validators,
        ...
        parameters,
        reference_gas_price,
        validator_report_records: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
        <a href="stake_subsidy.md#0x3_stake_subsidy">stake_subsidy</a>,
        safe_mode: <b>false</b>,
        safe_mode_storage_rewards: <a href="dependencies/mgo-framework/balance.md#0x2_balance_zero">balance::zero</a>(),
        safe_mode_computation_rewards: <a href="dependencies/mgo-framework/balance.md#0x2_balance_zero">balance::zero</a>(),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_create_system_parameters">create_system_parameters</a>(
    ...
    ctx: &<b>mut</b> TxContext,
): <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParameters">SystemParameters</a> {
    <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParameters">SystemParameters</a> {
        epoch_duration_ms,
...
<a name="0x3_mgo_system_state_inner_v1_to_v2"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_v1_to_v2">v1_to_v2</a>(self: <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInner">MgoSystemStateInner</a>): <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a> {
    <b>let</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInner">MgoSystemStateInner</a> {
        epoch,
        protocol_version,
    ...
    <b>let</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParameters">SystemParameters</a> {
        epoch_duration_ms,
        stake_subsidy_start_epoch,
        max_validator_count,
        min_validator_joining_stake,
    ...
    <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a> {
        epoch,
        protocol_version,
        system_state_version: 2,
        validators,
        <a href="storage_fund.md#0x3_storage_fund">storage_fund</a>,
        parameters: <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemParametersV2">SystemParametersV2</a> {
            epoch_duration_ms,
            stake_subsidy_start_epoch,
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_add_validator_candidate">request_add_validator_candidate</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ...
    <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="validator.md#0x3_validator_new">validator::new</a>(
        <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx),
        pubkey_bytes,
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_remove_validator_candidate">request_remove_validator_candidate</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ctx: &<b>mut</b> TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_add_validator">request_add_validator</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ctx: &TxContext,
) {
    <b>assert</b>!(
        ...
        <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ELimitExceeded">ELimitExceeded</a>,
    );
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_remove_validator">request_remove_validator</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_set_gas_price">request_set_gas_price</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ...
    <b>let</b> verified_cap = <a href="validator_set.md#0x3_validator_set_verify_cap">validator_set::verify_cap</a>(&<b>mut</b> self.validators, cap, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ACTIVE_OR_PENDING_VALIDATOR">ACTIVE_OR_PENDING_VALIDATOR</a>);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_set_candidate_validator_gas_price">set_candidate_validator_gas_price</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    cap: &UnverifiedValidatorOperationCap,
    new_gas_price: u64,
) {
    // Verify the represented <b>address</b> is an active or pending <a href="validator.md#0x3_validator">validator</a>, and the capability is still valid.
    <b>let</b> verified_cap = <a href="validator_set.md#0x3_validator_set_verify_cap">validator_set::verify_cap</a>(&<b>mut</b> self.validators, cap, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ANY_VALIDATOR">ANY_VALIDATOR</a>);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_set_commission_rate">request_set_commission_rate</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
...
<a name="0x3_mgo_system_state_inner_set_candidate_validator_commission_rate"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_set_candidate_validator_commission_rate">set_candidate_validator_commission_rate</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    new_commission_rate: u64,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_add_stake">request_add_stake</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    stake: Coin&lt;MGO&gt;,
    ...
    <a href="validator_set.md#0x3_validator_set_request_add_stake">validator_set::request_add_stake</a>(
        &<b>mut</b> self.validators,
        validator_address,
        <a href="dependencies/mgo-framework/coin.md#0x2_coin_into_balance">coin::into_balance</a>(stake),
        ctx,
    )
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_add_stake_mul_coin">request_add_stake_mul_coin</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ...
    <b>let</b> <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a> = <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_extract_coin_balance">extract_coin_balance</a>(stakes, stake_amount, ctx);
    <a href="validator_set.md#0x3_validator_set_request_add_stake">validator_set::request_add_stake</a>(&<b>mut</b> self.validators, validator_address, <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a>, ctx)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_request_withdraw_stake">request_withdraw_stake</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    staked_mgo: StakedMgo,
    ctx: &TxContext,
) : Balance&lt;MGO&gt; {
    <b>assert</b>!(
        stake_activation_epoch(&staked_mgo) &lt;= <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx),
        <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_EStakeWithdrawBeforeActivation">EStakeWithdrawBeforeActivation</a>
    );
    <a href="validator_set.md#0x3_validator_set_request_withdraw_stake">validator_set::request_withdraw_stake</a>(
        &<b>mut</b> self.validators, staked_mgo, ctx,
    )
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_report_validator">report_validator</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    cap: &UnverifiedValidatorOperationCap,
    reportee_addr: <b>address</b>,
) {
    // Reportee needs <b>to</b> be an active <a href="validator.md#0x3_validator">validator</a>
    <b>assert</b>!(<a href="validator_set.md#0x3_validator_set_is_active_validator_by_mgo_address">validator_set::is_active_validator_by_mgo_address</a>(&self.validators, reportee_addr), <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ENotValidator">ENotValidator</a>);
    ...
    <b>let</b> verified_cap = <a href="validator_set.md#0x3_validator_set_verify_cap">validator_set::verify_cap</a>(&<b>mut</b> self.validators, cap, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ACTIVE_VALIDATOR_ONLY">ACTIVE_VALIDATOR_ONLY</a>);
    <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_report_validator_impl">report_validator_impl</a>(verified_cap, reportee_addr, &<b>mut</b> self.validator_report_records);
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_undo_report_validator">undo_report_validator</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, cap: &<a href="validator_cap.md#0x3_validator_cap_UnverifiedValidatorOperationCap">validator_cap::UnverifiedValidatorOperationCap</a>, reportee_addr: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_undo_report_validator">undo_report_validator</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    cap: &UnverifiedValidatorOperationCap,
    reportee_addr: <b>address</b>,
) {
    <b>let</b> verified_cap = <a href="validator_set.md#0x3_validator_set_verify_cap">validator_set::verify_cap</a>(&<b>mut</b> self.validators, cap, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ACTIVE_VALIDATOR_ONLY">ACTIVE_VALIDATOR_ONLY</a>);
    <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_undo_report_validator_impl">undo_report_validator_impl</a>(verified_cap, reportee_addr, &<b>mut</b> self.validator_report_records);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_report_validator_impl">report_validator_impl</a>(
    ...
    <b>assert</b>!(reporter_address != reportee_addr, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ECannotReportOneself">ECannotReportOneself</a>);
    <b>if</b> (!<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(validator_report_records, &reportee_addr)) {
        <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(validator_report_records, reportee_addr, <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_singleton">vec_set::singleton</a>(reporter_address));
    } <b>else</b> {
        <b>let</b> reporters = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get_mut">vec_map::get_mut</a>(validator_report_records, &reportee_addr);
        <b>if</b> (!<a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_contains">vec_set::contains</a>(reporters, &reporter_address)) {
            <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_insert">vec_set::insert</a>(reporters, reporter_address);
        }
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_undo_report_validator_impl">undo_report_validator_impl</a>(
    verified_cap: ValidatorOperationCap,
    reportee_addr: <b>address</b>,
    validator_report_records: &<b>mut</b> VecMap&lt;<b>address</b>, VecSet&lt;<b>address</b>&gt;&gt;,
) {
    <b>assert</b>!(<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(validator_report_records, &reportee_addr), <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_EReportRecordNotFound">EReportRecordNotFound</a>);
    <b>let</b> reporters = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get_mut">vec_map::get_mut</a>(validator_report_records, &reportee_addr);
    ...
    <b>assert</b>!(<a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_contains">vec_set::contains</a>(reporters, &reporter_addr), <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_EReportRecordNotFound">EReportRecordNotFound</a>);

    <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_remove">vec_set::remove</a>(reporters, &reporter_addr);
    <b>if</b> (<a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_is_empty">vec_set::is_empty</a>(reporters)) {
        <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(validator_report_records, &reportee_addr);
    }
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_rotate_operation_cap">rotate_operation_cap</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    ctx: &<b>mut</b> TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_name">update_validator_name</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    name: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_description">update_validator_description</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    description: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_image_url">update_validator_image_url</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    image_url: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_project_url">update_validator_project_url</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    project_url: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_network_address">update_validator_next_epoch_network_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_network_address">update_candidate_validator_network_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    network_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<a name="0x3_mgo_system_state_inner_update_validator_next_epoch_p2p_address"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_p2p_address">update_validator_next_epoch_p2p_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    p2p_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_p2p_address">update_candidate_validator_p2p_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    p2p_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_primary_address">update_validator_next_epoch_primary_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    primary_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<a name="0x3_mgo_system_state_inner_update_candidate_validator_primary_address"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_primary_address">update_candidate_validator_primary_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    primary_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_worker_address">update_validator_next_epoch_worker_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    worker_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_worker_address">update_candidate_validator_worker_address</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    worker_address: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_protocol_pubkey">update_validator_next_epoch_protocol_pubkey</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, protocol_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, proof_of_possession: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_protocol_pubkey">update_validator_next_epoch_protocol_pubkey</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
...
<a name="0x3_mgo_system_state_inner_update_candidate_validator_protocol_pubkey"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_protocol_pubkey">update_candidate_validator_protocol_pubkey</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, protocol_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, proof_of_possession: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_protocol_pubkey">update_candidate_validator_protocol_pubkey</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    protocol_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    proof_of_possession: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
...
<a name="0x3_mgo_system_state_inner_update_validator_next_epoch_worker_pubkey"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_worker_pubkey">update_validator_next_epoch_worker_pubkey</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, worker_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_worker_pubkey">update_validator_next_epoch_worker_pubkey</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
...
<a name="0x3_mgo_system_state_inner_update_candidate_validator_worker_pubkey"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_worker_pubkey">update_candidate_validator_worker_pubkey</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, worker_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_worker_pubkey">update_candidate_validator_worker_pubkey</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    worker_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<a name="0x3_mgo_system_state_inner_update_validator_next_epoch_network_pubkey"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_network_pubkey">update_validator_next_epoch_network_pubkey</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, network_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_validator_next_epoch_network_pubkey">update_validator_next_epoch_network_pubkey</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
...
<a name="0x3_mgo_system_state_inner_update_candidate_validator_network_pubkey"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_network_pubkey">update_candidate_validator_network_pubkey</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, network_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_update_candidate_validator_network_pubkey">update_candidate_validator_network_pubkey</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    network_pubkey: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ctx: &TxContext,
) {
...
<a name="0x3_mgo_system_state_inner_advance_epoch"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_advance_epoch">advance_epoch</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    new_epoch: u64,
    ...
    <b>let</b> bps_denominator_u64 = (<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a> <b>as</b> u64);
    // Rates can't be higher than 100%.
    <b>assert</b>!(
        storage_fund_reinvest_rate &lt;= bps_denominator_u64
        && reward_slashing_rate &lt;= bps_denominator_u64,
        <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_EBpsTooLarge">EBpsTooLarge</a>,
    );
    ...
    <b>let</b> safe_mode_storage_rewards = <a href="dependencies/mgo-framework/balance.md#0x2_balance_withdraw_all">balance::withdraw_all</a>(&<b>mut</b> self.safe_mode_storage_rewards);
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> storage_reward, safe_mode_storage_rewards);
    <b>let</b> safe_mode_computation_rewards = <a href="dependencies/mgo-framework/balance.md#0x2_balance_withdraw_all">balance::withdraw_all</a>(&<b>mut</b> self.safe_mode_computation_rewards);
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> computation_reward, safe_mode_computation_rewards);
    ...
    <b>let</b> storage_charge = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&storage_reward);
    <b>let</b> computation_charge = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&computation_reward);
    ...
    <b>let</b> <a href="stake_subsidy.md#0x3_stake_subsidy">stake_subsidy</a> =
        <b>if</b> (<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) &gt;= self.parameters.stake_subsidy_start_epoch  &&
            epoch_start_timestamp_ms &gt;= prev_epoch_start_timestamp + self.parameters.epoch_duration_ms)
        {
            ...
            <a href="dependencies/mgo-framework/balance.md#0x2_balance_zero">balance::zero</a>()
        };

    <b>let</b> stake_subsidy_amount = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&<a href="stake_subsidy.md#0x3_stake_subsidy">stake_subsidy</a>);
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> computation_reward, <a href="stake_subsidy.md#0x3_stake_subsidy">stake_subsidy</a>);
    ...
    <b>let</b> storage_fund_reward = <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> computation_reward, (storage_fund_reward_amount <b>as</b> u64));
    <b>let</b> storage_fund_reinvestment_amount =
        storage_fund_reward_amount * (storage_fund_reinvest_rate <b>as</b> u128) / <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>;
    <b>let</b> storage_fund_reinvestment = <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(
    ...
    <b>assert</b>!(new_epoch == self.epoch, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_EAdvancedToWrongEpoch">EAdvancedToWrongEpoch</a>);

    <b>let</b> computation_reward_amount_before_distribution = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&computation_reward);
    <b>let</b> storage_fund_reward_amount_before_distribution = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&storage_fund_reward);
    ...
    <b>let</b> computation_reward_amount_after_distribution = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&computation_reward);
    <b>let</b> storage_fund_reward_amount_after_distribution = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&storage_fund_reward);
    ...
    // remaining <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a> in `storage_fund_reward` and `computation_reward`.
    // All of these go <b>to</b> the storage fund.
    <b>let</b> leftover_staking_rewards = storage_fund_reward;
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> leftover_staking_rewards, computation_reward);
    <b>let</b> leftover_storage_fund_inflow = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&leftover_staking_rewards);
    ...
    <a href="dependencies/mgo-framework/event.md#0x2_event_emit">event::emit</a>(
        <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SystemEpochInfoEvent">SystemEpochInfoEvent</a> {
            epoch: self.epoch,
    ...
    <b>assert</b>!(self.safe_mode_storage_rebates == 0
        && <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&self.safe_mode_storage_rewards) == 0
        && <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&self.safe_mode_computation_rewards) == 0, <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_ESafeModeGasNotProcessed">ESafeModeGasNotProcessed</a>);
...
<a name="0x3_mgo_system_state_inner_epoch"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_epoch">epoch</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_epoch">epoch</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): u64 {
    self.epoch
}
</code></pre>
...
<a name="0x3_mgo_system_state_inner_protocol_version"></a>

## Function `protocol_version`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_protocol_version">protocol_version</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_protocol_version">protocol_version</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): u64 {
...
<a name="0x3_mgo_system_state_inner_system_state_version"></a>

## Function `system_state_version`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_system_state_version">system_state_version</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_system_state_version">system_state_version</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): u64 {
...
<a name="0x3_mgo_system_state_inner_genesis_system_state_version"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_genesis_system_state_version">genesis_system_state_version</a>(): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_genesis_system_state_version">genesis_system_state_version</a>(): u64 {
    <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_SYSTEM_STATE_VERSION_V1">SYSTEM_STATE_VERSION_V1</a>
}
</code></pre>
...
<a name="0x3_mgo_system_state_inner_epoch_start_timestamp_ms"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_epoch_start_timestamp_ms">epoch_start_timestamp_ms</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_epoch_start_timestamp_ms">epoch_start_timestamp_ms</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): u64 {
...
<a name="0x3_mgo_system_state_inner_validator_stake_amount"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_validator_stake_amount">validator_stake_amount</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, validator_addr: <b>address</b>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_validator_stake_amount">validator_stake_amount</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>, validator_addr: <b>address</b>): u64 {
...
<a name="0x3_mgo_system_state_inner_validator_staking_pool_id"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_validator_staking_pool_id">validator_staking_pool_id</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, validator_addr: <b>address</b>): <a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_validator_staking_pool_id">validator_staking_pool_id</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>, validator_addr: <b>address</b>): ID {
...
<a name="0x3_mgo_system_state_inner_validator_staking_pool_mappings"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_validator_staking_pool_mappings">validator_staking_pool_mappings</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): &<a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>, <b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_validator_staking_pool_mappings">validator_staking_pool_mappings</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): &Table&lt;ID, <b>address</b>&gt; {
...
<a name="0x3_mgo_system_state_inner_get_reporters_of"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_get_reporters_of">get_reporters_of</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, addr: <b>address</b>): <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_VecSet">vec_set::VecSet</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_get_reporters_of">get_reporters_of</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>, addr: <b>address</b>): VecSet&lt;<b>address</b>&gt; {

    <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.validator_report_records, &addr)) {
        *<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(&self.validator_report_records, &addr)
    } <b>else</b> {
        <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_empty">vec_set::empty</a>()
    }
}
</code></pre>
...
<a name="0x3_mgo_system_state_inner_get_storage_fund_total_balance"></a>

## Function `get_storage_fund_total_balance`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_get_storage_fund_total_balance">get_storage_fund_total_balance</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_get_storage_fund_total_balance">get_storage_fund_total_balance</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): u64 {
...
<a name="0x3_mgo_system_state_inner_get_storage_fund_object_rebates"></a>

## Function `get_storage_fund_object_rebates`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_get_storage_fund_object_rebates">get_storage_fund_object_rebates</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): u64
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_get_storage_fund_object_rebates">get_storage_fund_object_rebates</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): u64 {
...
<a name="0x3_mgo_system_state_inner_pool_exchange_rates"></a>

## Function `pool_exchange_rates`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_pool_exchange_rates">pool_exchange_rates</a>(self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>, pool_id: &<a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>): &<a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_pool_exchange_rates">pool_exchange_rates</a>(
    self: &<b>mut</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>,
    pool_id: &ID
...
<a name="0x3_mgo_system_state_inner_active_validator_addresses"></a>

## Function `active_validator_addresses`



<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_active_validator_addresses">active_validator_addresses</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">mgo_system_state_inner::MgoSystemStateInnerV2</a>): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_active_validator_addresses">active_validator_addresses</a>(self: &<a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_MgoSystemStateInnerV2">MgoSystemStateInnerV2</a>): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt; {
...
<a name="0x3_mgo_system_state_inner_extract_coin_balance"></a>

## Function `extract_coin_balance`

Extract required Balance from vector of Coin<MGO>, transfer the remainder back to sender.


<pre><code><b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_extract_coin_balance">extract_coin_balance</a>(coins: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="dependencies/mgo-framework/coin.md#0x2_coin_Coin">coin::Coin</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;&gt;, amount: <a href="dependencies/move-stdlib/option.md#0x1_option_Option">option::Option</a>&lt;u64&gt;, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="mgo_system_state_inner.md#0x3_mgo_system_state_inner_extract_coin_balance">extract_coin_balance</a>(coins: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Coin&lt;MGO&gt;&gt;, amount: <a href="dependencies/move-stdlib/option.md#0x1_option_Option">option::Option</a>&lt;u64&gt;, ctx: &<b>mut</b> TxContext): Balance&lt;MGO&gt; {
    <b>let</b> merged_coin = <a href="dependencies/move-stdlib/vector.md#0x1_vector_pop_back">vector::pop_back</a>(&<b>mut</b> coins);
    <a href="dependencies/mgo-framework/pay.md#0x2_pay_join_vec">pay::join_vec</a>(&<b>mut</b> merged_coin, coins);

    <b>let</b> total_balance = <a href="dependencies/mgo-framework/coin.md#0x2_coin_into_balance">coin::into_balance</a>(merged_coin);
    ...
    <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&amount)) {
        ...
        <b>let</b> <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a> = <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> total_balance, amount);
        // <a href="dependencies/mgo-framework/transfer.md#0x2_transfer">transfer</a> back the remainder <b>if</b> non zero.
        <b>if</b> (<a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&total_balance) &gt; 0) {
            <a href="dependencies/mgo-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(<a href="dependencies/mgo-framework/coin.md#0x2_coin_from_balance">coin::from_balance</a>(total_balance, ctx), <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx));
        } <b>else</b> {
            <a href="dependencies/mgo-framework/balance.md#0x2_balance_destroy_zero">balance::destroy_zero</a>(total_balance);
        };
