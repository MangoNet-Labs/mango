...
-  [Resource `StakedMgo`](#0x3_staking_pool_StakedMgo)
...
-  [Function `unwrap_staked_mgo`](#0x3_staking_pool_unwrap_staked_mgo)
...
-  [Function `mgo_balance`](#0x3_staking_pool_mgo_balance)
-  [Function `pool_id`](#0x3_staking_pool_pool_id)
-  [Function `staked_mgo_amount`](#0x3_staking_pool_staked_mgo_amount)
...
-  [Function `split_staked_mgo`](#0x3_staking_pool_split_staked_mgo)
-  [Function `join_staked_mgo`](#0x3_staking_pool_join_staked_mgo)
...
-  [Function `mgo_amount`](#0x3_staking_pool_mgo_amount)
...
-  [Function `get_mgo_amount`](#0x3_staking_pool_get_mgo_amount)
...
<dt>
<code>mgo_balance: u64</code>
</dt>
<dd>
 The total number of MGO tokens in this pool, including the MGO in the rewards_pool, as well as in all the principal
 in the <code><a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a></code> object, updated at epoch boundaries.
</dd>
<dt>
<code>rewards_pool: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>exchange_rates: <a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>pending_total_mgo_withdraw: u64</code>
</dt>
<dd>
 Pending stake withdrawn during the current epoch, emptied at epoch boundaries.
 This includes both the principal and rewards MGO withdrawn.
</dd>
<dt>
...
Struct representing the exchange rate of the stake pool token to MGO.
...
<a name="0x3_staking_pool_StakedMgo"></a>

## Resource `StakedMgo`

A self-custodial object holding the staked MGO tokens.


<pre><code><b>struct</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> <b>has</b> store, key
</code></pre>
...
<dt>
<code>pool_id: <a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a></code>
</dt>
<dd>
...
<dt>
<code>principal: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;</code>
</dt>
<dd>
 The staked MGO tokens.
</dd>
</dl>
...
<a name="0x3_staking_pool_EDelegationOfZeroMgo"></a>



<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EDelegationOfZeroMgo">EDelegationOfZeroMgo</a>: u64 = 17;
</code></pre>
...
<a name="0x3_staking_pool_EIncompatibleStakedMgo"></a>



<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EIncompatibleStakedMgo">EIncompatibleStakedMgo</a>: u64 = 12;
</code></pre>



<a name="0x3_staking_pool_EInsufficientMgoTokenBalance"></a>



<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EInsufficientMgoTokenBalance">EInsufficientMgoTokenBalance</a>: u64 = 3;
</code></pre>
...
<a name="0x3_staking_pool_EStakedMgoBelowThreshold"></a>



<pre><code><b>const</b> <a href="staking_pool.md#0x3_staking_pool_EStakedMgoBelowThreshold">EStakedMgoBelowThreshold</a>: u64 = 18;
</code></pre>
...
StakedMgo objects cannot be split to below this amount.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_new">new</a>(ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_new">new</a>(ctx: &<b>mut</b> TxContext) : <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a> {
    <b>let</b> exchange_rates = <a href="dependencies/mgo-framework/table.md#0x2_table_new">table::new</a>(ctx);
    <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a> {
        ...
        mgo_balance: 0,
        rewards_pool: <a href="dependencies/mgo-framework/balance.md#0x2_balance_zero">balance::zero</a>(),
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_add_stake">request_add_stake</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, stake: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, stake_activation_epoch: u64, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_add_stake">request_add_stake</a>(
...
) : <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> {
    ...
    <b>assert</b>!(mgo_amount &gt; 0, <a href="staking_pool.md#0x3_staking_pool_EDelegationOfZeroMgo">EDelegationOfZeroMgo</a>);
    <b>let</b> staked_mgo = <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> {
        id: <a href="dependencies/mgo-framework/object.md#0x2_object_new">object::new</a>(ctx),
        pool_id: <a href="dependencies/mgo-framework/object.md#0x2_object_id">object::id</a>(pool),
        stake_activation_epoch,
        principal: stake,
    };
    pool.pending_stake = pool.pending_stake + mgo_amount;
    staked_mgo
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_request_withdraw_stake">request_withdraw_stake</a>(
    pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>,
    staked_mgo: <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>,
    ctx: &TxContext
) : Balance&lt;MGO&gt; {
    <b>let</b> (pool_token_withdraw_amount, principal_withdraw) =
        <a href="staking_pool.md#0x3_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool, staked_mgo);
    <b>let</b> principal_withdraw_amount = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&principal_withdraw);

    <b>let</b> rewards_withdraw = <a href="staking_pool.md#0x3_staking_pool_withdraw_rewards">withdraw_rewards</a>(
        pool, principal_withdraw_amount, pool_token_withdraw_amount, <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx)
    );
    <b>let</b> total_mgo_withdraw_amount = principal_withdraw_amount + <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&rewards_withdraw);

    pool.pending_total_mgo_withdraw = pool.pending_total_mgo_withdraw + total_mgo_withdraw_amount;
    ...
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> principal_withdraw, rewards_withdraw);
    principal_withdraw
}
</code></pre>
...
Withdraw the principal MGO stored in the StakedMgo object, and calculate the corresponding amount of pool
tokens using exchange rate at staking epoch.
Returns values are amount of pool tokens withdrawn and withdrawn principal portion of MGO.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, staked_mgo: <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>): (u64, <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_withdraw_from_principal">withdraw_from_principal</a>(
    ...
    <b>assert</b>!(staked_mgo.pool_id == <a href="dependencies/mgo-framework/object.md#0x2_object_id">object::id</a>(pool), <a href="staking_pool.md#0x3_staking_pool_EWrongPool">EWrongPool</a>);

    <b>let</b> exchange_rate_at_staking_epoch = <a href="staking_pool.md#0x3_staking_pool_pool_token_exchange_rate_at_epoch">pool_token_exchange_rate_at_epoch</a>(pool, staked_mgo.stake_activation_epoch);
    <b>let</b> principal_withdraw = <a href="staking_pool.md#0x3_staking_pool_unwrap_staked_mgo">unwrap_staked_mgo</a>(staked_mgo);
    <b>let</b> pool_token_withdraw_amount = <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(&exchange_rate_at_staking_epoch, <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&principal_withdraw));
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_unwrap_staked_mgo">unwrap_staked_mgo</a>(staked_mgo: <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>): Balance&lt;MGO&gt; {
    <b>let</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> {
        id,
        pool_id: _,
...
Called at epoch advancement times to add rewards (in MGO) to the staking pool.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_deposit_rewards">deposit_rewards</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>, rewards: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_deposit_rewards">deposit_rewards</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, rewards: Balance&lt;MGO&gt;) {
    pool.mgo_balance = pool.mgo_balance + <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&rewards);
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> pool.rewards_pool, rewards);
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_process_pending_stakes_and_withdraws">process_pending_stakes_and_withdraws</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, ctx: &TxContext) {
    ...
    <a href="dependencies/mgo-framework/table.md#0x2_table_add">table::add</a>(
        ...
        new_epoch,
        <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a> { mgo_amount: pool.mgo_balance, pool_token_amount: pool.pool_token_balance },
    );
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_process_pending_stake_withdraw">process_pending_stake_withdraw</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>) {
    pool.mgo_balance = pool.mgo_balance - pool.pending_total_mgo_withdraw;
    pool.pool_token_balance = pool.pool_token_balance - pool.pending_pool_token_withdraw;
    pool.pending_total_mgo_withdraw = 0;
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_process_pending_stake">process_pending_stake</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>) {
    ...
    <b>let</b> latest_exchange_rate =
        <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a> { mgo_amount: pool.mgo_balance, pool_token_amount: pool.pool_token_balance };
    pool.mgo_balance = pool.mgo_balance + pool.pending_stake;
    pool.pool_token_balance = <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(&latest_exchange_rate, pool.mgo_balance);
...
1. Calculates the total amount of MGO (including principal and rewards) that the provided pool tokens represent
...
portion because the principal portion was already taken out of the staker's self custodied StakedMgo.
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_withdraw_rewards">withdraw_rewards</a>(
    ...
    <b>let</b> total_mgo_withdraw_amount = <a href="staking_pool.md#0x3_staking_pool_get_mgo_amount">get_mgo_amount</a>(&exchange_rate, pool_token_withdraw_amount);
    <b>let</b> reward_withdraw_amount =
        <b>if</b> (total_mgo_withdraw_amount &gt;= principal_withdraw_amount)
            total_mgo_withdraw_amount - principal_withdraw_amount
        <b>else</b> 0;
    // This may happen when we are withdrawing everything from the pool and
    // the rewards pool <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a> may be less than reward_withdraw_amount.
    // TODO: FIGURE OUT EXACTLY WHY THIS CAN HAPPEN.
    reward_withdraw_amount = <a href="dependencies/mgo-framework/math.md#0x2_math_min">math::min</a>(reward_withdraw_amount, <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&pool.rewards_pool));
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> pool.rewards_pool, reward_withdraw_amount)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_activate_staking_pool">activate_staking_pool</a>(pool: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, activation_epoch: u64) {
    // Add the initial exchange rate <b>to</b> the <a href="dependencies/mgo-framework/table.md#0x2_table">table</a>.
    <a href="dependencies/mgo-framework/table.md#0x2_table_add">table::add</a>(
        &<b>mut</b> pool.exchange_rates,
        activation_epoch,
...
<a name="0x3_staking_pool_mgo_balance"></a>

## Function `mgo_balance`



<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_mgo_balance">mgo_balance</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">staking_pool::StakingPool</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_mgo_balance">mgo_balance</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>): u64 { pool.mgo_balance }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_pool_id">pool_id</a>(staked_mgo: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>): <a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_pool_id">pool_id</a>(staked_mgo: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>): ID { staked_mgo.pool_id }
</code></pre>
...
<a name="0x3_staking_pool_staked_mgo_amount"></a>

## Function `staked_mgo_amount`



<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_staked_mgo_amount">staked_mgo_amount</a>(staked_mgo: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_staked_mgo_amount">staked_mgo_amount</a>(staked_mgo: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>): u64 { <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&staked_mgo.principal) }
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_stake_activation_epoch">stake_activation_epoch</a>(staked_mgo: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_stake_activation_epoch">stake_activation_epoch</a>(staked_mgo: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>): u64 {
    staked_mgo.stake_activation_epoch
}
</code></pre>
...
Split StakedMgo <code>self</code> to two parts, one with principal <code>split_amount</code>,
and the remaining principal is left in <code>self</code>.
All the other parameters of the StakedMgo like <code>stake_activation_epoch</code> or <code>pool_id</code> remain the same.


<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split">split</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>, split_amount: u64, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split">split</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>, split_amount: u64, ctx: &<b>mut</b> TxContext): <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> {
    <b>let</b> original_amount = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&self.principal);
    <b>assert</b>!(split_amount &lt;= original_amount, <a href="staking_pool.md#0x3_staking_pool_EInsufficientMgoTokenBalance">EInsufficientMgoTokenBalance</a>);
    ...
    <b>assert</b>!(remaining_amount &gt;= <a href="staking_pool.md#0x3_staking_pool_MIN_STAKING_THRESHOLD">MIN_STAKING_THRESHOLD</a>, <a href="staking_pool.md#0x3_staking_pool_EStakedMgoBelowThreshold">EStakedMgoBelowThreshold</a>);
    <b>assert</b>!(split_amount &gt;= <a href="staking_pool.md#0x3_staking_pool_MIN_STAKING_THRESHOLD">MIN_STAKING_THRESHOLD</a>, <a href="staking_pool.md#0x3_staking_pool_EStakedMgoBelowThreshold">EStakedMgoBelowThreshold</a>);
    <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> {
        id: <a href="dependencies/mgo-framework/object.md#0x2_object_new">object::new</a>(ctx),
        pool_id: self.pool_id,
        stake_activation_epoch: self.stake_activation_epoch,
        principal: <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> self.principal, split_amount),
    }
}
</code></pre>
...
<a name="0x3_staking_pool_split_staked_mgo"></a>

## Function `split_staked_mgo`

Split the given StakedMgo to the two parts, one with principal <code>split_amount</code>,
transfer the newly split part to the sender address.


<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split_staked_mgo">split_staked_mgo</a>(stake: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>, split_amount: u64, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_split_staked_mgo">split_staked_mgo</a>(stake: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>, split_amount: u64, ctx: &<b>mut</b> TxContext) {
    <a href="dependencies/mgo-framework/transfer.md#0x2_transfer_transfer">transfer::transfer</a>(<a href="staking_pool.md#0x3_staking_pool_split">split</a>(stake, split_amount, ctx), <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx));
}
</code></pre>
...
<a name="0x3_staking_pool_join_staked_mgo"></a>

## Function `join_staked_mgo`

Consume the staked mgo <code>other</code> and add its value to <code>self</code>.
Aborts if some of the staking parameters are incompatible (pool id, stake activation epoch, etc.)


<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_join_staked_mgo">join_staked_mgo</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>, other: <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_join_staked_mgo">join_staked_mgo</a>(self: &<b>mut</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>, other: <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>) {
    <b>assert</b>!(<a href="staking_pool.md#0x3_staking_pool_is_equal_staking_metadata">is_equal_staking_metadata</a>(self, &other), <a href="staking_pool.md#0x3_staking_pool_EIncompatibleStakedMgo">EIncompatibleStakedMgo</a>);
    <b>let</b> <a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a> {
        id,
        pool_id: _,
        stake_activation_epoch: _,
    ...
    <a href="dependencies/mgo-framework/object.md#0x2_object_delete">object::delete</a>(id);
    <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> self.principal, principal);
}
</code></pre>
...
Returns true if all the staking parameters of the staked mgo except the principal are identical


<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_is_equal_staking_metadata">is_equal_staking_metadata</a>(self: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>, other: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_is_equal_staking_metadata">is_equal_staking_metadata</a>(self: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>, other: &<a href="staking_pool.md#0x3_staking_pool_StakedMgo">StakedMgo</a>): bool {
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_pool_token_exchange_rate_at_epoch">pool_token_exchange_rate_at_epoch</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, epoch: u64): <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a> {
    ...
    <b>let</b> epoch = <a href="dependencies/mgo-framework/math.md#0x2_math_min">math::min</a>(clamped_epoch, epoch);
    ...
    // Find the latest epoch that's earlier than the given epoch <b>with</b> an entry in the <a href="dependencies/mgo-framework/table.md#0x2_table">table</a>
    <b>while</b> (epoch &gt;= activation_epoch) {
        <b>if</b> (<a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&pool.exchange_rates, epoch)) {
            <b>return</b> *<a href="dependencies/mgo-framework/table.md#0x2_table_borrow">table::borrow</a>(&pool.exchange_rates, epoch)
        };
        epoch = epoch - 1;
    };
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_pending_stake_withdraw_amount">pending_stake_withdraw_amount</a>(<a href="staking_pool.md#0x3_staking_pool">staking_pool</a>: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>): u64 {
    <a href="staking_pool.md#0x3_staking_pool">staking_pool</a>.pending_total_mgo_withdraw
}
</code></pre>
...
<a name="0x3_staking_pool_mgo_amount"></a>

## Function `mgo_amount`



<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_mgo_amount">mgo_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="staking_pool.md#0x3_staking_pool_mgo_amount">mgo_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a>): u64 {
    exchange_rate.mgo_amount
}
</code></pre>
...
<a name="0x3_staking_pool_get_mgo_amount"></a>

## Function `get_mgo_amount`



<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_mgo_amount">get_mgo_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>, token_amount: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_mgo_amount">get_mgo_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a>, token_amount: u64): u64 {
    // When either amount is 0, that means we have no stakes <b>with</b> this pool.
    // The other amount might be non-zero when there's dust left in the pool.
    <b>if</b> (exchange_rate.mgo_amount == 0 || exchange_rate.pool_token_amount == 0) {
        <b>return</b> token_amount
    };
    <b>let</b> res = (exchange_rate.mgo_amount <b>as</b> u128)
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>, mgo_amount: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(exchange_rate: &<a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a>, mgo_amount: u64): u64 {
    // When either amount is 0, that means we have no stakes <b>with</b> this pool.
    // The other amount might be non-zero when there's dust left in the pool.
    <b>if</b> (exchange_rate.mgo_amount == 0 || exchange_rate.pool_token_amount == 0) {
        <b>return</b> mgo_amount
    };
    <b>let</b> res = (exchange_rate.pool_token_amount <b>as</b> u128)
            * (mgo_amount <b>as</b> u128)
            / (exchange_rate.mgo_amount <b>as</b> u128);
    (res <b>as</b> u64)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_initial_exchange_rate">initial_exchange_rate</a>(): <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a> {
    <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">PoolTokenExchangeRate</a> { mgo_amount: 0, pool_token_amount: 0 }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="staking_pool.md#0x3_staking_pool_check_balance_invariants">check_balance_invariants</a>(pool: &<a href="staking_pool.md#0x3_staking_pool_StakingPool">StakingPool</a>, epoch: u64) {
    <b>let</b> exchange_rate = <a href="staking_pool.md#0x3_staking_pool_pool_token_exchange_rate_at_epoch">pool_token_exchange_rate_at_epoch</a>(pool, epoch);
    // check that the pool token <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a> and <a href="dependencies/mgo-framework/mgo.md#0x2_mgo">mgo</a> <a href="dependencies/mgo-framework/balance.md#0x2_balance">balance</a> ratio matches the exchange rate stored.
    <b>let</b> expected = <a href="staking_pool.md#0x3_staking_pool_get_token_amount">get_token_amount</a>(&exchange_rate, pool.mgo_balance);
