...
-  [Function `is_active_validator_by_mgo_address`](#0x3_validator_set_is_active_validator_by_mgo_address)
...
<b>use</b> <a href="dependencies/mgo-framework/priority_queue.md#0x2_priority_queue">0x2::priority_queue</a>;
<b>use</b> <a href="dependencies/mgo-framework/table.md#0x2_table">0x2::table</a>;
<b>use</b> <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec">0x2::table_vec</a>;
...
<dt>
<code>active_validators: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;</code>
</dt>
<dd>
 The current list of active validators.
</dd>
<dt>
<code>pending_active_validators: <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>pending_removals: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>staking_pool_mappings: <a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>, <b>address</b>&gt;</code>
</dt>
<dd>
 Mappings from staking pool's ID to the mgo address of a validator.
</dd>
<dt>
<code>inactive_validators: <a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>, <a href="validator_wrapper.md#0x3_validator_wrapper_ValidatorWrapper">validator_wrapper::ValidatorWrapper</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>validator_candidates: <a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;<b>address</b>, <a href="validator_wrapper.md#0x3_validator_wrapper_ValidatorWrapper">validator_wrapper::ValidatorWrapper</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>at_risk_validators: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>tallying_rule_reporters: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;</code>
</dt>
<dd>
...
<dt>
<code>staking_pool_id: <a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a></code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_new">new</a>(init_active_validators: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_new">new</a>(init_active_validators: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, ctx: &<b>mut</b> TxContext): <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a> {
    ...
    <b>let</b> staking_pool_mappings = <a href="dependencies/mgo-framework/table.md#0x2_table_new">table::new</a>(ctx);
    <b>let</b> num_validators = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&init_active_validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; num_validators) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&init_active_validators, i);
        <a href="dependencies/mgo-framework/table.md#0x2_table_add">table::add</a>(&<b>mut</b> staking_pool_mappings, staking_pool_id(<a href="validator.md#0x3_validator">validator</a>), mgo_address(<a href="validator.md#0x3_validator">validator</a>));
        i = i + 1;
    };
    <b>let</b> validators = <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a> {
        total_stake,
        active_validators: init_active_validators,
        pending_active_validators: <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_empty">table_vec::empty</a>(ctx),
        pending_removals: <a href="dependencies/move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>(),
        staking_pool_mappings,
        inactive_validators: <a href="dependencies/mgo-framework/table.md#0x2_table_new">table::new</a>(ctx),
        validator_candidates: <a href="dependencies/mgo-framework/table.md#0x2_table_new">table::new</a>(ctx),
        at_risk_validators: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
...
Called by <code><a href="mgo_system.md#0x3_mgo_system">mgo_system</a></code> to add a new validator candidate.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator_candidate">request_add_validator_candidate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, <a href="validator.md#0x3_validator">validator</a>: <a href="validator.md#0x3_validator_Validator">validator::Validator</a>, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator_candidate">request_add_validator_candidate</a>(
    ...
    <b>let</b> validator_address = mgo_address(&<a href="validator.md#0x3_validator">validator</a>);
    <b>assert</b>!(
        !<a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address),
    ...
    <a href="dependencies/mgo-framework/table.md#0x2_table_add">table::add</a>(&<b>mut</b> self.staking_pool_mappings, staking_pool_id(&<a href="validator.md#0x3_validator">validator</a>), validator_address);
    <a href="dependencies/mgo-framework/table.md#0x2_table_add">table::add</a>(
        &<b>mut</b> self.validator_candidates,
        mgo_address(&<a href="validator.md#0x3_validator">validator</a>),
...
Called by <code><a href="mgo_system.md#0x3_mgo_system">mgo_system</a></code> to remove a validator candidate, and move them to <code>inactive_validators</code>.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_remove_validator_candidate">request_remove_validator_candidate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, ctx: &<b>mut</b> TxContext) {
    <b>let</b> validator_address = <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
     <b>assert</b>!(
        <a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address),
        <a href="validator_set.md#0x3_validator_set_ENotValidatorCandidate">ENotValidatorCandidate</a>
    );
    <b>let</b> wrapper = <a href="dependencies/mgo-framework/table.md#0x2_table_remove">table::remove</a>(&<b>mut</b> self.validator_candidates, validator_address);
    ...
    <a href="dependencies/mgo-framework/table.md#0x2_table_remove">table::remove</a>(&<b>mut</b> self.staking_pool_mappings, staking_pool_id);

    // Deactivate the staking pool.
    <a href="validator.md#0x3_validator_deactivate">validator::deactivate</a>(&<b>mut</b> <a href="validator.md#0x3_validator">validator</a>, <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx));
...
Called by <code><a href="mgo_system.md#0x3_mgo_system">mgo_system</a></code> to add a new validator to <code>pending_active_validators</code>, which will be
processed at the end of epoch.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator">request_add_validator</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, min_joining_stake_amount: u64, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_validator">request_add_validator</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, min_joining_stake_amount: u64, ctx: &TxContext) {
    <b>let</b> validator_address = <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx);
    <b>assert</b>!(
        <a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address),
        <a href="validator_set.md#0x3_validator_set_ENotValidatorCandidate">ENotValidatorCandidate</a>
    ...
    <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_push_back">table_vec::push_back</a>(&<b>mut</b> self.pending_active_validators, <a href="validator.md#0x3_validator">validator</a>);
}
</code></pre>
...
Called by <code><a href="mgo_system.md#0x3_mgo_system">mgo_system</a></code>, to remove a validator.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_remove_validator">request_remove_validator</a>(
    ...
    <b>assert</b>!(<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt), <a href="validator_set.md#0x3_validator_set_ENotAValidator">ENotAValidator</a>);
    <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
    <b>assert</b>!(
        !<a href="dependencies/move-stdlib/vector.md#0x1_vector_contains">vector::contains</a>(&self.pending_removals, &validator_index),
        <a href="validator_set.md#0x3_validator_set_EValidatorAlreadyRemoved">EValidatorAlreadyRemoved</a>
    );
    <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> self.pending_removals, validator_index);
}
</code></pre>
...
Called by <code><a href="mgo_system.md#0x3_mgo_system">mgo_system</a></code>, to add a new stake to the validator.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_stake">request_add_stake</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_address: <b>address</b>, stake: <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="staking_pool.md#0x3_staking_pool_StakedMgo">staking_pool::StakedMgo</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_add_stake">request_add_stake</a>(
    ...
    <b>let</b> mgo_amount = <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&stake);
    <b>assert</b>!(mgo_amount &gt;= <a href="validator_set.md#0x3_validator_set_MIN_STAKING_THRESHOLD">MIN_STAKING_THRESHOLD</a>, <a href="validator_set.md#0x3_validator_set_EStakingBelowThreshold">EStakingBelowThreshold</a>);
    ...
    <a href="validator.md#0x3_validator_request_add_stake">validator::request_add_stake</a>(<a href="validator.md#0x3_validator">validator</a>, stake, <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx), ctx)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_withdraw_stake">request_withdraw_stake</a>(
    ...
    <b>let</b> staking_pool_id = pool_id(&staked_mgo);
    <b>let</b> <a href="validator.md#0x3_validator">validator</a> =
        <b>if</b> (<a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.staking_pool_mappings, staking_pool_id)) { // This is an active <a href="validator.md#0x3_validator">validator</a>.
            <b>let</b> validator_address = *<a href="dependencies/mgo-framework/table.md#0x2_table_borrow">table::borrow</a>(&self.staking_pool_mappings, pool_id(&staked_mgo));
            ...
            <b>assert</b>!(<a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.inactive_validators, staking_pool_id), <a href="validator_set.md#0x3_validator_set_ENoPoolFound">ENoPoolFound</a>);
            <b>let</b> wrapper = <a href="dependencies/mgo-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.inactive_validators, staking_pool_id);
    ...
    <a href="validator.md#0x3_validator_request_withdraw_stake">validator::request_withdraw_stake</a>(<a href="validator.md#0x3_validator">validator</a>, staked_mgo, ctx)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_request_set_commission_rate">request_set_commission_rate</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, new_commission_rate: u64, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_advance_epoch">advance_epoch</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, computation_reward: &<b>mut</b> <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, storage_fund_reward: &<b>mut</b> <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, validator_report_records: &<b>mut</b> <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_VecSet">vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, reward_slashing_rate: u64, low_stake_threshold: u64, very_low_stake_threshold: u64, low_stake_grace_period: u64, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_advance_epoch">advance_epoch</a>(
    self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>,
    computation_reward: &<b>mut</b> Balance&lt;MGO&gt;,
    storage_fund_reward: &<b>mut</b> Balance&lt;MGO&gt;,
    ...
    <b>let</b> new_epoch = <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) + 1;
    ...
    <b>let</b> (unadjusted_staking_reward_amounts, unadjusted_storage_fund_reward_amounts) = <a href="validator_set.md#0x3_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(
        ...
        total_voting_power,
        <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(computation_reward),
        <a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(storage_fund_reward),
    );
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_update_and_process_low_stake_departures">update_and_process_low_stake_departures</a>(
    ...
    <b>let</b> i = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.active_validators);
    <b>while</b> (i &gt; 0) {
        i = i - 1;
        <b>let</b> validator_ref = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&self.active_validators, i);
        <b>let</b> validator_address = <a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(validator_ref);
        ...
        <b>if</b> (stake &gt;= low_stake_threshold) {
            ...
            <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.at_risk_validators, &validator_address)) {
                <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(&<b>mut</b> self.at_risk_validators, &validator_address);
            }
            ...
            <b>let</b> new_low_stake_period =
                <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.at_risk_validators, &validator_address)) {
                    <b>let</b> num_epochs = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get_mut">vec_map::get_mut</a>(&<b>mut</b> self.at_risk_validators, &validator_address);
                    *num_epochs = *num_epochs + 1;
                    *num_epochs
                } <b>else</b> {
                    <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(&<b>mut</b> self.at_risk_validators, validator_address, 1);
                    1
                };
            ...
            <b>if</b> (new_low_stake_period &gt; low_stake_grace_period) {
                <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_remove">vector::remove</a>(&<b>mut</b> self.active_validators, i);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_effectuate_staged_metadata">effectuate_staged_metadata</a>(
    ...
    <b>let</b> num_validators = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.active_validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; num_validators) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow_mut">vector::borrow_mut</a>(&<b>mut</b> self.active_validators, i);
...
Called by <code><a href="mgo_system.md#0x3_mgo_system">mgo_system</a></code> to derive reference gas price for the new epoch.
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_derive_reference_gas_price">derive_reference_gas_price</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    ...
    <b>let</b> num_validators = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(vs);
    <b>let</b> entries = <a href="dependencies/move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> i = 0;
    <b>while</b> (i &lt; num_validators) {
        <b>let</b> v = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(vs, i);
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_validator_staking_pool_id">validator_staking_pool_id</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_address: <b>address</b>): <a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_staking_pool_mappings">staking_pool_mappings</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>): &<a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;<a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>, <b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_pool_exchange_rates">pool_exchange_rates</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, pool_id: &<a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>): &<a href="dependencies/mgo-framework/table.md#0x2_table_Table">table::Table</a>&lt;u64, <a href="staking_pool.md#0x3_staking_pool_PoolTokenExchangeRate">staking_pool::PoolTokenExchangeRate</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_pool_exchange_rates">pool_exchange_rates</a>(
    ...
    <b>let</b> <a href="validator.md#0x3_validator">validator</a> =
        ...
        <b>if</b> (<a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.staking_pool_mappings, *pool_id)) {
            <b>let</b> validator_address = *<a href="dependencies/mgo-framework/table.md#0x2_table_borrow">table::borrow</a>(&self.staking_pool_mappings, *pool_id);
            ...
            <b>let</b> wrapper = <a href="dependencies/mgo-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.inactive_validators, *pool_id);
            <a href="validator_wrapper.md#0x3_validator_wrapper_load_validator_maybe_upgrade">validator_wrapper::load_validator_maybe_upgrade</a>(wrapper)
        };
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_next_epoch_validator_count">next_epoch_validator_count</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.active_validators) - <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&self.pending_removals) + <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_length">table_vec::length</a>(&self.pending_active_validators)
}
</code></pre>
...
<a name="0x3_validator_set_is_active_validator_by_mgo_address"></a>

## Function `is_active_validator_by_mgo_address`

Returns true iff the address exists in active validators.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_active_validator_by_mgo_address">is_active_validator_by_mgo_address</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_address: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_active_validator_by_mgo_address">is_active_validator_by_mgo_address</a>(
    self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
): bool {
    <a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&<a href="validator_set.md#0x3_validator_set_find_validator">find_validator</a>(&self.active_validators, validator_address))
}
</code></pre>
...
It differs from <code>is_active_validator_by_mgo_address</code> in that the former checks
only the mgo address but this function looks at more metadata.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_duplicate_validator">is_duplicate_validator</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, new_validator: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): bool
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_duplicate_validator">is_duplicate_validator</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, new_validator: &Validator): bool {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_count_duplicates_vec">count_duplicates_vec</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, <a href="validator.md#0x3_validator">validator</a>: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_count_duplicates_vec">count_duplicates_vec</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, <a href="validator.md#0x3_validator">validator</a>: &Validator): u64 {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_count_duplicates_tablevec">count_duplicates_tablevec</a>(validators: &<a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, <a href="validator.md#0x3_validator">validator</a>: &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_count_duplicates_tablevec">count_duplicates_tablevec</a>(validators: &TableVec&lt;Validator&gt;, <a href="validator.md#0x3_validator">validator</a>: &Validator): u64 {
    <b>let</b> len = <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_length">table_vec::length</a>(validators);
    <b>let</b> i = 0;
    <b>let</b> result = 0;
    <b>while</b> (i &lt; len) {
        <b>let</b> v = <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(validators, i);
        <b>if</b> (<a href="validator.md#0x3_validator_is_duplicate">validator::is_duplicate</a>(v, <a href="validator.md#0x3_validator">validator</a>)) {
            result = result + 1;
        };
        i = i + 1;
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, validator_address: <b>address</b>): &<b>mut</b> Validator {
    <b>if</b> (<a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, validator_address)) {
        <b>let</b> wrapper = <a href="dependencies/mgo-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.validator_candidates, validator_address);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_find_validator">find_validator</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, validator_address: <b>address</b>): <a href="dependencies/move-stdlib/option.md#0x1_option_Option">option::Option</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_find_validator">find_validator</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, validator_address: <b>address</b>): Option&lt;u64&gt; {
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
        <b>let</b> v = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(validators, i);
        <b>if</b> (<a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(v) == validator_address) {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(validators: &<a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_TableVec">table_vec::TableVec</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, validator_address: <b>address</b>): <a href="dependencies/move-stdlib/option.md#0x1_option_Option">option::Option</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(validators: &TableVec&lt;Validator&gt;, validator_address: <b>address</b>): Option&lt;u64&gt; {
    <b>let</b> length = <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_length">table_vec::length</a>(validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
        <b>let</b> v = <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(validators, i);
        <b>if</b> (<a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(v) == validator_address) {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_indices">get_validator_indices</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, validator_addresses: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_indices">get_validator_indices</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, validator_addresses: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt; {
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validator_addresses);
    <b>let</b> i = 0;
    <b>let</b> res = <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>[];
    <b>while</b> (i &lt; length) {
        <b>let</b> addr = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(validator_addresses, i);
        <b>let</b> index_opt = <a href="validator_set.md#0x3_validator_set_find_validator">find_validator</a>(validators, addr);
        <b>assert</b>!(<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&index_opt), <a href="validator_set.md#0x3_validator_set_ENotAValidator">ENotAValidator</a>);
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> res, <a href="dependencies/move-stdlib/option.md#0x1_option_destroy_some">option::destroy_some</a>(index_opt));
        i = i + 1;
    };
    res
}
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_mut">get_validator_mut</a>(validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, validator_address: <b>address</b>): &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_mut">get_validator_mut</a>(
    ...
    <b>assert</b>!(<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt), <a href="validator_set.md#0x3_validator_set_ENotAValidator">ENotAValidator</a>);
    <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
    <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow_mut">vector::borrow_mut</a>(validators, validator_index)
}
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_active_or_pending_or_candidate_validator_mut">get_active_or_pending_or_candidate_validator_mut</a>(
    ...
    <b>let</b> validator_index_opt = <a href="validator_set.md#0x3_validator_set_find_validator">find_validator</a>(&self.active_validators, validator_address);
    <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt)) {
        <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
        <b>return</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow_mut">vector::borrow_mut</a>(&<b>mut</b> self.active_validators, validator_index)
    };
    ...
    <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt)) {
        <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
        <b>return</b> <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_borrow_mut">table_vec::borrow_mut</a>(&<b>mut</b> self.pending_active_validators, validator_index)
    };
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_mut_with_ctx">get_validator_mut_with_ctx</a>(self: &<b>mut</b> <a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): &<b>mut</b> <a href="validator.md#0x3_validator_Validator">validator::Validator</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_ref">get_validator_ref</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, validator_address: <b>address</b>): &<a href="validator.md#0x3_validator_Validator">validator::Validator</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_get_validator_ref">get_validator_ref</a>(
    ...
    <b>assert</b>!(<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt), <a href="validator_set.md#0x3_validator_set_ENotAValidator">ENotAValidator</a>);
    <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
    <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(validators, validator_index)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_active_or_pending_or_candidate_validator_ref">get_active_or_pending_or_candidate_validator_ref</a>(
    ...
    <b>let</b> validator_index_opt = <a href="validator_set.md#0x3_validator_set_find_validator">find_validator</a>(&self.active_validators, validator_address);
    <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt) || which_validator == <a href="validator_set.md#0x3_validator_set_ACTIVE_VALIDATOR_ONLY">ACTIVE_VALIDATOR_ONLY</a>) {
        <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
        <b>return</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&self.active_validators, validator_index)
    };
    <b>let</b> validator_index_opt = <a href="validator_set.md#0x3_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(&self.pending_active_validators, validator_address);
    <b>if</b> (<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt) || which_validator == <a href="validator_set.md#0x3_validator_set_ACTIVE_OR_PENDING_VALIDATOR">ACTIVE_OR_PENDING_VALIDATOR</a>) {
        <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
        <b>return</b> <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(&self.pending_active_validators, validator_index)
    };
    <b>let</b> wrapper = <a href="dependencies/mgo-framework/table.md#0x2_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> self.validator_candidates, validator_address);
    <a href="validator_wrapper.md#0x3_validator_wrapper_load_validator_maybe_upgrade">validator_wrapper::load_validator_maybe_upgrade</a>(wrapper)
}
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_active_validator_ref">get_active_validator_ref</a>(
    ...
    <b>assert</b>!(<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt), <a href="validator_set.md#0x3_validator_set_ENotAValidator">ENotAValidator</a>);
    <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
    <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&self.active_validators, validator_index)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_get_pending_validator_ref">get_pending_validator_ref</a>(
    ...
    <b>let</b> validator_index_opt = <a href="validator_set.md#0x3_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(&self.pending_active_validators, validator_address);
    <b>assert</b>!(<a href="dependencies/move-stdlib/option.md#0x1_option_is_some">option::is_some</a>(&validator_index_opt), <a href="validator_set.md#0x3_validator_set_ENotAPendingValidator">ENotAPendingValidator</a>);
    <b>let</b> validator_index = <a href="dependencies/move-stdlib/option.md#0x1_option_extract">option::extract</a>(&<b>mut</b> validator_index_opt);
    <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_borrow">table_vec::borrow</a>(&self.pending_active_validators, validator_index)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_verify_cap">verify_cap</a>(
    ...
    <b>assert</b>!(<a href="validator.md#0x3_validator_operation_cap_id">validator::operation_cap_id</a>(<a href="validator.md#0x3_validator">validator</a>) == &<a href="dependencies/mgo-framework/object.md#0x2_object_id">object::id</a>(cap), <a href="validator_set.md#0x3_validator_set_EInvalidCap">EInvalidCap</a>);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_pending_removals">process_pending_removals</a>(
    ...
    <b>while</b> (!<a href="dependencies/move-stdlib/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&self.pending_removals)) {
        <b>let</b> index = <a href="dependencies/move-stdlib/vector.md#0x1_vector_pop_back">vector::pop_back</a>(&<b>mut</b> self.pending_removals);
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_remove">vector::remove</a>(&<b>mut</b> self.active_validators, index);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_validator_departure">process_validator_departure</a>(
    ...
    <b>let</b> new_epoch = <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_epoch">tx_context::epoch</a>(ctx) + 1;
    <b>let</b> validator_address = <a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(&<a href="validator.md#0x3_validator">validator</a>);
    ...
    <a href="dependencies/mgo-framework/table.md#0x2_table_remove">table::remove</a>(&<b>mut</b> self.staking_pool_mappings, validator_pool_id);
    <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&self.at_risk_validators, &validator_address)) {
        <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(&<b>mut</b> self.at_risk_validators, &validator_address);
    };
    ...
    <a href="dependencies/mgo-framework/event.md#0x2_event_emit">event::emit</a>(
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_clean_report_records_leaving_validator">clean_report_records_leaving_validator</a>(
    ...
    <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(validator_report_records, &leaving_validator_addr)) {
        <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(validator_report_records, &leaving_validator_addr);
    };

    // Remove the reports submitted by this <a href="validator.md#0x3_validator">validator</a>
    <b>let</b> reported_validators = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_keys">vec_map::keys</a>(validator_report_records);
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(&reported_validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
        <b>let</b> reported_validator_addr = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&reported_validators, i);
        <b>let</b> reporters = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get_mut">vec_map::get_mut</a>(validator_report_records, reported_validator_addr);
        <b>if</b> (<a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_contains">vec_set::contains</a>(reporters, &leaving_validator_addr)) {
            <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_remove">vec_set::remove</a>(reporters, &leaving_validator_addr);
            <b>if</b> (<a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_is_empty">vec_set::is_empty</a>(reporters)) {
                <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_remove">vec_map::remove</a>(validator_report_records, reported_validator_addr);
            };
        };
        i = i + 1;
    }
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_pending_validators">process_pending_validators</a>(
    ...
    <b>while</b> (!<a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_is_empty">table_vec::is_empty</a>(&self.pending_active_validators)) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/mgo-framework/table_vec.md#0x2_table_vec_pop_back">table_vec::pop_back</a>(&<b>mut</b> self.pending_active_validators);
        ...
        <a href="dependencies/mgo-framework/event.md#0x2_event_emit">event::emit</a>(
            <a href="validator_set.md#0x3_validator_set_ValidatorJoinEvent">ValidatorJoinEvent</a> {
                epoch: new_epoch,
                validator_address: <a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(&<a href="validator.md#0x3_validator">validator</a>),
                staking_pool_id: staking_pool_id(&<a href="validator.md#0x3_validator">validator</a>),
            }
        );
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> self.active_validators, <a href="validator.md#0x3_validator">validator</a>);
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_sort_removal_list">sort_removal_list</a>(withdraw_list: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_sort_removal_list">sort_removal_list</a>(withdraw_list: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;) {
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(withdraw_list);
    <b>let</b> i = 1;
    <b>while</b> (i &lt; length) {
        <b>let</b> cur = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(withdraw_list, i);
        <b>let</b> j = i;
        <b>while</b> (j &gt; 0) {
            j = j - 1;
            <b>if</b> (*<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(withdraw_list, j) &gt; cur) {
                <a href="dependencies/move-stdlib/vector.md#0x1_vector_swap">vector::swap</a>(withdraw_list, j, j + 1);
            } <b>else</b> {
                <b>break</b>
            };
        };
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_pending_stakes_and_withdraws">process_pending_stakes_and_withdraws</a>(validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, ctx: &<a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_process_pending_stakes_and_withdraws">process_pending_stakes_and_withdraws</a>(
    validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, ctx: &TxContext
) {
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_calculate_total_stakes">calculate_total_stakes</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_calculate_total_stakes">calculate_total_stakes</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;): u64 {
    <b>let</b> stake = 0;
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_adjust_stake_and_gas_price">adjust_stake_and_gas_price</a>(validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_adjust_stake_and_gas_price">adjust_stake_and_gas_price</a>(validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;) {
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow_mut">vector::borrow_mut</a>(validators, i);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_reward_adjustments">compute_reward_adjustments</a>(slashed_validator_indices: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, reward_slashing_rate: u64, unadjusted_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, unadjusted_storage_fund_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;): (u64, <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, u64&gt;, u64, <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_reward_adjustments">compute_reward_adjustments</a>(
    slashed_validator_indices: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    reward_slashing_rate: u64,
    unadjusted_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    unadjusted_storage_fund_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
): (
    ...
    <b>let</b> individual_staking_reward_adjustments = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>();
    <b>let</b> total_storage_fund_reward_adjustment = 0;
    <b>let</b> individual_storage_fund_reward_adjustments = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>();

    <b>while</b> (!<a href="dependencies/move-stdlib/vector.md#0x1_vector_is_empty">vector::is_empty</a>(&slashed_validator_indices)) {
        <b>let</b> validator_index = <a href="dependencies/move-stdlib/vector.md#0x1_vector_pop_back">vector::pop_back</a>(&<b>mut</b> slashed_validator_indices);
        ...
        <b>let</b> unadjusted_staking_reward = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(unadjusted_staking_reward_amounts, validator_index);
        ...
        <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(&<b>mut</b> individual_staking_reward_adjustments, validator_index, (staking_reward_adjustment_u128 <b>as</b> u64));
        ...
        <b>let</b> unadjusted_storage_fund_reward = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(unadjusted_storage_fund_reward_amounts, validator_index);
        <b>let</b> storage_fund_reward_adjustment_u128 =
            (unadjusted_storage_fund_reward <b>as</b> u128) * (reward_slashing_rate <b>as</b> u128)
            / <a href="validator_set.md#0x3_validator_set_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>;
        <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_insert">vec_map::insert</a>(&<b>mut</b> individual_storage_fund_reward_adjustments, validator_index, (storage_fund_reward_adjustment_u128 <b>as</b> u64));
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_slashed_validators">compute_slashed_validators</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, validator_report_records: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_VecSet">vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_slashed_validators">compute_slashed_validators</a>(
    ...
    <b>let</b> slashed_validators = <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>[];
    <b>while</b> (!<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_is_empty">vec_map::is_empty</a>(&validator_report_records)) {
        <b>let</b> (validator_address, reporters) = <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_pop">vec_map::pop</a>(&<b>mut</b> validator_report_records);
        <b>assert</b>!(
            <a href="validator_set.md#0x3_validator_set_is_active_validator_by_mgo_address">is_active_validator_by_mgo_address</a>(self, validator_address),
        ...
        <b>let</b> reporter_votes = <a href="validator_set.md#0x3_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(&self.active_validators, &<a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_into_keys">vec_set::into_keys</a>(reporters));
        <b>if</b> (reporter_votes &gt;= <a href="voting_power.md#0x3_voting_power_quorum_threshold">voting_power::quorum_threshold</a>()) {
            <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> slashed_validators, validator_address);
        }
    };
    slashed_validators
}
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(
    ...
    <b>let</b> staking_reward_amounts = <a href="dependencies/move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> storage_fund_reward_amounts = <a href="dependencies/move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> storage_fund_reward_per_validator = total_storage_fund_reward / length;
    <b>let</b> i = 0;
    <b>while</b> (i &lt; length) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(validators, i);
        ...
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> staking_reward_amounts, (reward_amount <b>as</b> u64));
        // Storage fund's share of the rewards are equally distributed among validators.
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> storage_fund_reward_amounts, storage_fund_reward_per_validator);
        i = i + 1;
    };
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_adjusted_reward_distribution">compute_adjusted_reward_distribution</a>(validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, total_voting_power: u64, total_slashed_validator_voting_power: u64, unadjusted_staking_reward_amounts: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, unadjusted_storage_fund_reward_amounts: <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, total_staking_reward_adjustment: u64, individual_staking_reward_adjustments: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, u64&gt;, total_storage_fund_reward_adjustment: u64, individual_storage_fund_reward_adjustments: <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;u64, u64&gt;): (<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_compute_adjusted_reward_distribution">compute_adjusted_reward_distribution</a>(
    ...
    <b>let</b> adjusted_staking_reward_amounts = <a href="dependencies/move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> adjusted_storage_fund_reward_amounts = <a href="dependencies/move-stdlib/vector.md#0x1_vector_empty">vector::empty</a>();

    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    <b>let</b> num_unslashed_validators = length - <a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_size">vec_map::size</a>(&individual_staking_reward_adjustments);
    ...
    <b>while</b> (i &lt; length) {
        ...
        <b>let</b> unadjusted_staking_reward_amount = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&unadjusted_staking_reward_amounts, i);
        <b>let</b> adjusted_staking_reward_amount =
            ...
            <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&individual_staking_reward_adjustments, &i)) {
                <b>let</b> adjustment = *<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(&individual_staking_reward_adjustments, &i);
        ...
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> adjusted_staking_reward_amounts, adjusted_staking_reward_amount);

        // Compute adjusted storage fund reward.
        <b>let</b> unadjusted_storage_fund_reward_amount = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(&unadjusted_storage_fund_reward_amounts, i);
        <b>let</b> adjusted_storage_fund_reward_amount =
            // If the <a href="validator.md#0x3_validator">validator</a> is one of the slashed ones, then subtract the adjustment.
            <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(&individual_storage_fund_reward_adjustments, &i)) {
                <b>let</b> adjustment = *<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(&individual_storage_fund_reward_adjustments, &i);
        ...
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> adjusted_storage_fund_reward_amounts, adjusted_storage_fund_reward_amount);
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_distribute_reward">distribute_reward</a>(validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, adjusted_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, adjusted_storage_fund_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, staking_rewards: &<b>mut</b> <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, storage_fund_reward: &<b>mut</b> <a href="dependencies/mgo-framework/balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="dependencies/mgo-framework/mgo.md#0x2_mgo_MGO">mgo::MGO</a>&gt;, ctx: &<b>mut</b> <a href="dependencies/mgo-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_distribute_reward">distribute_reward</a>(
    validators: &<b>mut</b> <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;,
    adjusted_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    adjusted_storage_fund_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    staking_rewards: &<b>mut</b> Balance&lt;MGO&gt;,
    storage_fund_reward: &<b>mut</b> Balance&lt;MGO&gt;,
    ctx: &<b>mut</b> TxContext
) {
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(validators);
    ...
    <b>while</b> (i &lt; length) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow_mut">vector::borrow_mut</a>(validators, i);
        <b>let</b> staking_reward_amount = *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(adjusted_staking_reward_amounts, i);
        <b>let</b> staker_reward = <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(staking_rewards, staking_reward_amount);
        ...
        <b>let</b> validator_reward = <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(&<b>mut</b> staker_reward, (validator_commission_amount <b>as</b> u64));

        // Add storage fund rewards <b>to</b> the <a href="validator.md#0x3_validator">validator</a>'s reward.
        <a href="dependencies/mgo-framework/balance.md#0x2_balance_join">balance::join</a>(&<b>mut</b> validator_reward, <a href="dependencies/mgo-framework/balance.md#0x2_balance_split">balance::split</a>(storage_fund_reward, *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(adjusted_storage_fund_reward_amounts, i)));
        ...
        <b>if</b> (<a href="dependencies/mgo-framework/balance.md#0x2_balance_value">balance::value</a>(&validator_reward) &gt; 0) {
            <b>let</b> validator_address = <a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(<a href="validator.md#0x3_validator">validator</a>);
            ...
            <a href="dependencies/mgo-framework/transfer.md#0x2_transfer_public_transfer">transfer::public_transfer</a>(rewards_stake, validator_address);
        } <b>else</b> {
            <a href="dependencies/mgo-framework/balance.md#0x2_balance_destroy_zero">balance::destroy_zero</a>(validator_reward);
        };
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_emit_validator_epoch_events">emit_validator_epoch_events</a>(new_epoch: u64, vs: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, pool_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, storage_fund_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;, report_records: &<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_VecSet">vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, slashed_validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="validator_set.md#0x3_validator_set_emit_validator_epoch_events">emit_validator_epoch_events</a>(
    new_epoch: u64,
    vs: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;,
    pool_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    storage_fund_staking_reward_amounts: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    report_records: &VecMap&lt;<b>address</b>, VecSet&lt;<b>address</b>&gt;&gt;,
    slashed_validators: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;,
) {
    <b>let</b> num_validators = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(vs);
    <b>let</b> i = 0;
    <b>while</b> (i &lt; num_validators) {
        <b>let</b> v = <a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(vs, i);
        <b>let</b> validator_address = <a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(v);
        <b>let</b> tallying_rule_reporters =
            <b>if</b> (<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_contains">vec_map::contains</a>(report_records, &validator_address)) {
                <a href="dependencies/mgo-framework/vec_set.md#0x2_vec_set_into_keys">vec_set::into_keys</a>(*<a href="dependencies/mgo-framework/vec_map.md#0x2_vec_map_get">vec_map::get</a>(report_records, &validator_address))
            } <b>else</b> {
                <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>[]
            };
        <b>let</b> tallying_rule_global_score =
            <b>if</b> (<a href="dependencies/move-stdlib/vector.md#0x1_vector_contains">vector::contains</a>(slashed_validators, &validator_address)) 0
            <b>else</b> 1;
        <a href="dependencies/mgo-framework/event.md#0x2_event_emit">event::emit</a>(
            <a href="validator_set.md#0x3_validator_set_ValidatorEpochInfoEventV2">ValidatorEpochInfoEventV2</a> {
                ...
                pool_staking_reward: *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(pool_staking_reward_amounts, i),
                storage_fund_staking_reward: *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(storage_fund_staking_reward_amounts, i),
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(vs: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;, addresses: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(vs: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt;, addresses: &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;): u64 {
    <b>let</b> sum = 0;
    <b>let</b> i = 0;
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(addresses);
    <b>while</b> (i &lt; length) {
        <b>let</b> <a href="validator.md#0x3_validator">validator</a> = <a href="validator_set.md#0x3_validator_set_get_validator_ref">get_validator_ref</a>(vs, *<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(addresses, i));
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_active_validators">active_validators</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>): &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<a href="validator.md#0x3_validator_Validator">validator::Validator</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_active_validators">active_validators</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): &<a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;Validator&gt; {
    &self.active_validators
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_validator_candidate">is_validator_candidate</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, addr: <b>address</b>): bool {
    <a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.validator_candidates, addr)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_inactive_validator">is_inactive_validator</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>, staking_pool_id: <a href="dependencies/mgo-framework/object.md#0x2_object_ID">object::ID</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="validator_set.md#0x3_validator_set_is_inactive_validator">is_inactive_validator</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>, staking_pool_id: ID): bool {
    <a href="dependencies/mgo-framework/table.md#0x2_table_contains">table::contains</a>(&self.inactive_validators, staking_pool_id)
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_active_validator_addresses">active_validator_addresses</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">validator_set::ValidatorSet</a>): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="validator_set.md#0x3_validator_set_active_validator_addresses">active_validator_addresses</a>(self: &<a href="validator_set.md#0x3_validator_set_ValidatorSet">ValidatorSet</a>): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt; {
    <b>let</b> vs = &self.active_validators;
    <b>let</b> res = <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>[];
    <b>let</b> i = 0;
    <b>let</b> length = <a href="dependencies/move-stdlib/vector.md#0x1_vector_length">vector::length</a>(vs);
    <b>while</b> (i &lt; length) {
        <b>let</b> validator_address = <a href="validator.md#0x3_validator_mgo_address">validator::mgo_address</a>(<a href="dependencies/move-stdlib/vector.md#0x1_vector_borrow">vector::borrow</a>(vs, i));
        <a href="dependencies/move-stdlib/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> res, validator_address);
        i = i + 1;
    };
    res
}
