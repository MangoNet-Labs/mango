...
use mgo_types::crypto::EmptySignInfo;
...
impl WritePathPendingTransactionLog {
    ...
    pub fn finish_transaction(&self, tx: &TransactionDigest) -> MgoResult {
        ...
        write_batch.write().map_err(MgoError::from)
    }
