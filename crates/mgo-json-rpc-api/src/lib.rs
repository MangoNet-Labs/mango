...
pub struct JsonRpcMetrics {
    ...
    pub get_stake_mgo_result_size: Histogram,
    pub get_stake_mgo_result_size_total: IntCounter,

    pub get_stake_mgo_latency: Histogram,
    pub get_delegated_mgo_latency: Histogram,
...
impl JsonRpcMetrics {
    pub fn new(registry: &prometheus::Registry) -> Self {
        Self {
            ...
            .unwrap(),
            get_stake_mgo_result_size: Histogram::new_in_registry(
                "json_rpc_get_stake_mgo_result_size",
                "The return size for get_stake_mgo",
                registry,
            ),
            get_stake_mgo_result_size_total: register_int_counter_with_registry!(
                "json_rpc_get_stake_mgo_result_size_total",
                "The total return size for get_stake_mgo",
                registry
            )
            .unwrap(),
            get_stake_mgo_latency: Histogram::new_in_registry(
                "get_stake_mgo_latency",
                "The latency of get stake mgo, in ms",
                registry,
            ),
            get_delegated_mgo_latency: Histogram::new_in_registry(
                "get_delegated_mgo_latency",
                "The latency of get delegated mgo, in ms",
                registry,
            ),
