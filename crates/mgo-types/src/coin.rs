...
use crate::{base_types::ObjectID, id::UID, MGO_FRAMEWORK_ADDRESS};
use move_core_types::{
...
// Rust version of the Move mgo::coin::Coin type
...
impl Coin {
    ...
    pub fn is_coin(other: &StructTag) -> bool {
        other.address == MGO_FRAMEWORK_ADDRESS
...
// Rust version of the Move mgo::coin::TreasuryCap type
...
impl TreasuryCap {
    ...
    pub fn from_bcs_bytes(content: &[u8]) -> Result<Self, MgoError> {
        bcs::from_bytes(content).map_err(|err| MgoError::ObjectDeserializationError {
...
// Rust version of the Move mgo::coin::CoinMetadata type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
