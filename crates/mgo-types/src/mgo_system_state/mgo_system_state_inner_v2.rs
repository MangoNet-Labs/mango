...
use crate::mgo_system_state::get_validators_from_table_vec;
use crate::mgo_system_state::mgo_system_state_inner_v1::{
...
use super::mgo_system_state_inner_v1::ValidatorV1;
use super::mgo_system_state_summary::{MgoSystemStateSummary, MgoValidatorSummary};
use super::{AdvanceEpochParams, MgoSystemStateTrait};

/// Rust version of the Move mgo::mgo_system::SystemParametersV2 type
...
/// Rust version of the Move mgo_system::mgo_system::MgoSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct MgoSystemStateInnerV2 {
    pub epoch: u64,
...
impl MgoSystemStateTrait for MgoSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
