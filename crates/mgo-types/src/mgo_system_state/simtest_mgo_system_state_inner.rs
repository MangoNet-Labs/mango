...
use crate::mgo_system_state::epoch_start_mgo_system_state::{
    EpochStartSystemState, EpochStartValidatorInfoV1,
};
use crate::mgo_system_state::mgo_system_state_summary::{
    MgoSystemStateSummary, MgoValidatorSummary,
};
use crate::mgo_system_state::{AdvanceEpochParams, MgoSystemStateTrait};
...
pub struct SimTestMgoSystemStateInnerV1 {
    pub epoch: u64,
...
impl MgoSystemStateTrait for SimTestMgoSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_mgo_system_state_summary(self) -> MgoSystemStateSummary {
        MgoSystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestMgoSystemStateInnerShallowV2 {
...
impl MgoSystemStateTrait for SimTestMgoSystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestMgoSystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl MgoSystemStateTrait for SimTestMgoSystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
