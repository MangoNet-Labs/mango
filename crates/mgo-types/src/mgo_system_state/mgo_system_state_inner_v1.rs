...
use crate::base_types::{ObjectID, MgoAddress};
...
use super::epoch_start_mgo_system_state::EpochStartValidatorInfoV1;
use super::mgo_system_state_summary::{MgoSystemStateSummary, MgoValidatorSummary};
use super::{get_validators_from_table_vec, AdvanceEpochParams, MgoSystemStateTrait};
...
/// Rust version of the Move mgo::mgo_system::SystemParameters type
...
impl VerifiedValidatorMetadataV1 {
    pub fn mgo_pubkey_bytes(&self) -> AuthorityPublicKeyBytes {
...
impl ValidatorMetadataV1 {
    ...
    pub fn verify(&self) -> Result<VerifiedValidatorMetadataV1, u64> {
        ...
        verify_proof_of_possession(&pop, &protocol_pubkey, self.mgo_address)
            .map_err(|_| E_METADATA_INVALID_POP)?;
...
/// Rust version of the Move mgo::validator::Validator type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
impl ValidatorV1 {
    ...
    pub fn into_mgo_validator_summary(self) -> MgoValidatorSummary {
        let Self {
            metadata:
                ValidatorMetadataV1 {
                    mgo_address,
            ...
            staking_pool:
                StakingPoolV1 {
                    ...
                    mgo_balance: staking_pool_mgo_balance,
                    rewards_pool,
                    pool_token_balance,
                    exchange_rates:
                        Table {
...
/// Rust version of the Move mgo_system::staking_pool::StakingPool type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct StakingPoolV1 {
    ...
    pub pending_total_mgo_withdraw: u64,
    pub pending_pool_token_withdraw: u64,
    pub extra_fields: Bag,
}

/// Rust version of the Move mgo_system::validator_set::ValidatorSet type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct ValidatorSetV1 {
    ...
    pub at_risk_validators: VecMap<MgoAddress, u64>,
    pub extra_fields: Bag,
}

/// Rust version of the Move mgo_system::storage_fund::StorageFund type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
/// Rust version of the Move mgo_system::mgo_system::MgoSystemStateInner type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct MgoSystemStateInnerV1 {
    pub epoch: u64,
    ...
    pub validator_report_records: VecMap<MgoAddress, VecSet<MgoAddress>>,
...
impl MgoSystemStateTrait for MgoSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn get_current_epoch_committee(&self) -> CommitteeWithNetworkMetadata {
        ...
        for validator in &self.validators.active_validators {
            ...
            let name = verified_metadata.mgo_pubkey_bytes();
    ...
    fn into_mgo_system_state_summary(self) -> MgoSystemStateSummary {
        // If you are making any changes to MgoSystemStateV1 or any of its dependent types before
        // mainnet, please also update MgoSystemStateSummary and its corresponding TS type.
...
/// Rust version of the Move mgo_system::validator_cap::UnverifiedValidatorOperationCap type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct UnverifiedValidatorOperationCapV1 {
    pub id: ObjectID,
    pub authorizer_validator_address: MgoAddress,
}
