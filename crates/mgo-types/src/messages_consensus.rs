...
pub struct ConsensusTransaction {
    /// Encodes an u64 unique tracking id to allow us trace a message between Mgo and Narwhal.
...
impl AuthorityCapabilities {
    pub fn new(
        ...
        let generation = SystemTime::now()
            ...
            .expect("Mgo did not exist prior to 1970")
            .as_millis()
            .try_into()
            .expect("This build of mgo is not supported in the year 500,000,000");
        Self {
            authority,
            generation,
            supported_protocol_versions,
