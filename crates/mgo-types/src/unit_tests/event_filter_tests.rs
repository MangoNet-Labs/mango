...
use crate::base_types::{ObjectDigest, MgoAddress, TransactionDigest};
use crate::event::{Event, EventEnvelope};
use crate::filter::{EventFilter, Filter};
use crate::gas_coin::GasCoin;
use crate::object::OBJECT_START_VERSION;
use crate::{ObjectID, MOVE_STDLIB_ADDRESS, MGO_FRAMEWORK_ADDRESS};
...
fn test_move_event_filter() {
    ...
    let move_event = Event {
        package_id: ObjectID::from(MGO_FRAMEWORK_ADDRESS),
    ...
    let filters = vec![
        ...
        EventFilter::Package(ObjectID::from(MGO_FRAMEWORK_ADDRESS)),
...
fn test_transfer_filter() {
    ...
    let recipient = Owner::AddressOwner(MgoAddress::random_for_testing_only());
