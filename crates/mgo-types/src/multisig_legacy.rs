...
impl AuthenticatorTrait for MultiSigLegacy {
    fn verify_user_authenticator_epoch(&self, _: EpochId) -> Result<(), MgoError> {
        Ok(())
    }
...
pub fn bitmap_to_u16(roaring: RoaringBitmap) -> Result<u16, MgoError> {
