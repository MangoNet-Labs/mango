...
pub mod checked {
    ...
    use crate::{
        ...
        error::{ExecutionError, MgoResult, UserInputError, UserInputResult},
        gas_model::{gas_v2::MgoGasStatus as MgoGasStatusV2, tables::GasStatus},
        object::Object,
        mgo_serde::{BigInt, Readable},
    ...
    #[enum_dispatch(MgoGasStatusAPI)]
    #[derive(Debug)]
    pub enum MgoGasStatus {
    ...
    impl MgoGasStatus {
        pub fn new(
            ...
            Ok(Self::V2(MgoGasStatusV2::new_with_budget(
                gas_budget,
                gas_price,
                reference_gas_price,
                config,
        ...
        pub fn new_unmetered() -> Self {
            Self::V2(MgoGasStatusV2::new_unmetered())
        }

        // This is the only public API on MgoGasStatus, all other gas related operations should
