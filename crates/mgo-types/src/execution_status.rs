...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a MGO coin.")]
    InvalidGasObject,
    ...
    #[error(
        "Mgo Move Bytecode Verification Error. \
        Please run the Mgo Move Verifier for more information."
    )]
    MgoMoveVerificationError,
    ...
    #[error(
        "Mgo Move Bytecode Verification Timeout. \
        Please run the Mgo Move Verifier for more information."
    )]
    MgoMoveVerificationTimedout,
