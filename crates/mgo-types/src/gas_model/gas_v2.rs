...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, MgoGasStatusAPI};
    ...
    /// A list of constant costs of various operations in Mgo.
    pub struct MgoCostTable {
    ...
    impl std::fmt::Debug for MgoCostTable {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            // TODO: dump the fields.
            write!(f, "MgoCostTable(...)")
        }
    }
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Mgo) for in this object.
    ...
    impl MgoGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let mgo_cost_table = MgoCostTable::new(config, gas_price);
            let gas_rounding_step = config.gas_rounding_step_as_option();
            Self::new(
                GasStatus::new(
                    mgo_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> MgoGasStatus {
            Self::new(
    ...
    impl MgoGasStatusAPI for MgoGasStatus {
