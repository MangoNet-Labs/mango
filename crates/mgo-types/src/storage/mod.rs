...
) -> MgoResult<PackageFetchResults<PackageObject>> {
...
pub fn get_module_by_id<S: BackingPackageStore>(
    store: S,
    id: &ModuleId,
) -> anyhow::Result<Option<CompiledModule>, MgoError> {
...
pub fn transaction_input_object_keys(tx: &SenderSignedData) -> MgoResult<Vec<ObjectKey>> {
