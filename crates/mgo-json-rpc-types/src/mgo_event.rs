...
use mgo_types::event::{Event, EventEnvelope, EventID};
...
pub type EventPage = Page<MgoEvent, EventID>;
...
impl From<EventEnvelope> for MgoEvent {
...
impl From<MgoEvent> for Event {
    fn from(val: MgoEvent) -> Self {
        Event {
...
impl EventFilter {
    fn try_matches(&self, item: &MgoEvent) -> MgoResult<bool> {
        Ok(match self {
...
impl Filter<MgoEvent> for EventFilter {
    fn matches(&self, item: &MgoEvent) -> bool {
