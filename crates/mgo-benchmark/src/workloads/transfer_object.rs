...
use mgo_core::test_utils::make_transfer_object_transaction;
use mgo_types::{
...
pub struct TransferObjectTestPayload {
    ...
    transfer_from: MgoAddress,
    transfer_to: MgoAddress,
    gas: Vec<Gas>,
...
impl Workload<dyn Payload> for TransferObjectWorkload {
    ...
    async fn make_test_payloads(
        ...
        let mut gas_by_address: HashMap<MgoAddress, Vec<Gas>> = HashMap::new();
        ...
        let addresses: Vec<MgoAddress> = gas_by_address.keys().cloned().collect();
