...
use mgo_types::base_types::{random_object_ref, ObjectRef};
use mgo_types::effects::TransactionEffectsAPI;
use mgo_types::transaction::Command;
use mgo_types::transaction::{CallArg, ObjectArg};
use mgo_types::{base_types::ObjectID, object::Owner};
use mgo_types::{base_types::MgoAddress, crypto::get_key_pair, transaction::Transaction};
use mgo_types::{transaction::TransactionData, utils::to_sender_signed_transaction};
use tracing::debug;
...
impl Payload for AdversarialTestPayload {
    fn make_new_payload(&mut self, effects: &ExecutionEffects) {
        ...
        let stat = match effects {
            ...
            ExecutionEffects::MgoTransactionBlockEffects(_) => unimplemented!("Not impl"),
        };
