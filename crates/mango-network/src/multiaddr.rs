...
mod test {
    ...
    fn test_to_socket_addr_unsupported_protocol() {
        let multi_addr_dns = Multiaddr(multiaddr!(Dnsaddr("mango.mgo"), Tcp(10500u16)));
    ...
    fn test_get_hostname_port() {
        ...
        let multi_addr_dns = Multiaddr(multiaddr!(Dns("mango.mgo"), Tcp(10501u16)));
        assert_eq!(Some("mango.mgo".to_string()), multi_addr_dns.hostname());
