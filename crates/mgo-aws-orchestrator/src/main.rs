...
/// NOTE: Link these types to the correct protocol. Either Mgo or Narwhal.
// use protocol::mgo::{MgoBenchmarkType, MgoProtocol};
// type Protocol = MgoProtocol;
// type BenchmarkType = MgoBenchmarkType;
...
pub struct Opts {
    ...
    #[clap(
        long,
        value_name = "FILE",
        default_value = "crates/mgo-aws-orchestrator/assets/settings.json",
        global = true
    )]
