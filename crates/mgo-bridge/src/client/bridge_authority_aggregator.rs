...
use mgo_common::authority_aggregation::quorum_map_then_reduce_with_timeout;
use mgo_common::authority_aggregation::ReduceOutput;
use mgo_types::base_types::ConciseableName;
use mgo_types::committee::StakeUnit;
use mgo_types::committee::TOTAL_VOTING_POWER;
...
impl GetSigsState {
    ...
    fn handle_verified_signed_action(
        ...
        if self.total_ok_stake >= self.validity_threshold {
            ...
            let certified_action: mgo_types::message_envelope::Envelope<
                BridgeAction,
...
mod tests {
    ...
    use mgo_types::committee::VALIDITY_THRESHOLD;
    ...
    use crate::test_utils::{
        ...
        get_test_mgo_to_eth_bridge_action, sign_action_with_key,
    };
