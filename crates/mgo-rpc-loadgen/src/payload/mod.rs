...
use mgo_types::{
    base_types::MgoAddress, digests::TransactionDigest,
...
impl Command {
    ...
    pub fn new_pay_mgo() -> Self {
        Self {
            data: CommandData::PayMgo(PayMgo {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<MgoAddress>, chunk_size: usize) -> Self {
