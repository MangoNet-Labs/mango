...
use mgo_types::transaction::{CallArg, ObjectArg, TransactionData, TEST_ONLY_GAS_UNIT_FOR_PUBLISH};
use mgo_types::{Identifier, MGO_FRAMEWORK_ADDRESS};
...
impl SurferState {
    ...
    async fn process_tx_effects(&mut self, effects: &MgoTransactionBlockEffects) {
