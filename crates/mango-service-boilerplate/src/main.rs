...
use mango_service::get_mango_service;
use mango_service::metrics::start_basic_prometheus_server;
use mango_service::package_name;
use mango_service::package_version;
use mango_service::serve;
...
async fn main() -> Result<()> {
    ...
    let _guard = mango_service::logging::init();
    ...
    let app = get_mango_service(package_name!(), package_version!())
