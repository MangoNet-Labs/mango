...
use clap::Parser;
use mgo_single_node_benchmark::command::Command;
use mgo_single_node_benchmark::run_benchmark;
use mgo_single_node_benchmark::workload::Workload;

#[tokio::main]
async fn main() {
    let _guard = telemetry_subscribers::TelemetryConfig::new()
        .with_log_level("off,mgo_single_node_benchmark=info")
        .with_env()
        .init();
