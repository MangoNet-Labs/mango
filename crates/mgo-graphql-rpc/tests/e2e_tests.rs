...
mod tests {
    ...
    use mgo_graphql_rpc::client::simple_client::GraphqlQueryVariable;
    use mgo_graphql_rpc::client::ClientError;
    ...
    async fn test_simple_client_validator_cluster() {
        ...
        let cluster =
            mgo_graphql_rpc::test_infra::cluster::start_cluster(connection_config, None).await;
    ...
    async fn test_simple_client_simulator_cluster() {
        ...
        let connection_config = ConnectionConfig::ci_integration_test_cfg();
        let cluster = mgo_graphql_rpc::test_infra::cluster::serve_executor(
            connection_config,
    ...
    async fn test_transaction_execution() {
        ...
        let tx = cluster
            ...
            .await
            .transfer_mgo(Some(1_000), recipient)
            .build();
    ...
    use mgo_graphql_rpc::server::builder::tests::*;
