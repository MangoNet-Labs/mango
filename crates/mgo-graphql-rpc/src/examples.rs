...
pub fn generate_examples_for_docs() -> anyhow::Result<String> {
    ...
    md.write(
        r#"---
title: Examples
description: Query examples for working with the Mgo GraphQL RPC.
---
"#,
    )?;
    md.write("This page showcases a number of queries to interact with the network. These examples can also be found in the [repository](https://github.com/MangoNetworkOs/Mango/tree/main/crates/mgo-graphql-rpc/examples). You can use the [interactive online IDE](https://mainnet.mangonetwork.io/rpc/graphql) to run these examples.")?;
...
pub fn generate_markdown() -> anyhow::Result<String> {
    ...
    md.write("Mgo GraphQL Examples".heading(1))
        .map_err(|e| anyhow!(e))?;
...
fn test_generate_markdown() {
    ...
    if current_content != new_content {
        ...
        panic!("Doc examples have changed. Please run `mgo-graphql-rpc generate-examples` to update the docs. Diff: {}", res.join(""));
    }
}
