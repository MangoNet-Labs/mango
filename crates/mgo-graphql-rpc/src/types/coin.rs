...
use mgo_types::coin::Coin as NativeCoin;
...
fn coins_query(coin_type: TypeTag, owner: Option<MgoAddress>, lhs: i64, rhs: i64) -> RawQuery {
    build_objects_query(View::Consistent, lhs, rhs, move |query| {
        apply_filter(query, &coin_type, owner)
    })
}

fn apply_filter(mut query: RawQuery, coin_type: &TypeTag, owner: Option<MgoAddress>) -> RawQuery {
