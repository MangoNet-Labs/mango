...
pub(crate) struct TransactionBlockFilter {
    ...
    pub sign_address: Option<MgoAddress>,
    pub recv_address: Option<MgoAddress>,

    pub input_object: Option<MgoAddress>,
    pub changed_object: Option<MgoAddress>,
...
impl TransactionBlock {
    ...
    async fn sender(&self) -> Option<Address> {
        ...
        (sender != NativeMgoAddress::ZERO).then(|| Address {
            address: MgoAddress::from(sender),
