...
use super::mgons_registration::NameService;
...
use crate::types::mgo_address::MgoAddress;
...
#[graphql(
    name = "IOwner",
    field(name = "address", ty = "MgoAddress"),
    field(
        name = "objects",
    ...
    field(
        ...
        desc = "Total balance of all coins with marker type owned by this object or address. If \
                type is not supplied, it defaults to `0x2::mgo::MGO`."
    ),
    field(
        name = "balances",
        arg(name = "first", ty = "Option<u64>"),
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, StakedMgo>",
        desc = "The `0x3::staking_pool::StakedMgo` objects owned by this object or address."
    ),
    field(
        name = "default_mgons_name",
        ty = "Option<String>",
        desc = "The domain explicitly configured as the default domain pointing to this object or \
                address."
    ),
    field(
        name = "mgons_registrations",
        arg(name = "first", ty = "Option<u64>"),
        arg(name = "after", ty = "Option<object::Cursor>"),
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, MgonsRegistration>",
        desc = "The MgonsRegistration NFTs owned by this object or address. These grant the owner \
...
/// An Owner is an entity that can own an object. Each Owner is identified by a MgoAddress which
...
impl Owner {
    ...
    /// supplied, it defaults to `0x2::mgo::MGO`.
    ...
    /// The `0x3::staking_pool::StakedMgo` objects owned by this object or address.
    ...
    /// The MgonsRegistration NFTs owned by this object or address. These grant the owner the
