...
use async_graphql::*;
use mgo_json_rpc_types::BalanceChange as StoredBalanceChange;
use mgo_types::object::Owner as NativeOwner;

use super::{big_int::BigInt, move_type::MoveType, owner::Owner, mgo_address::MgoAddress};
...
impl BalanceChange {
    ...
    /// The inner type of the coin whose balance has changed (e.g. `0x2::mgo::MGO`).
