...
use async_graphql::*;
use mgo_json_rpc_types::{DevInspectResults, MgoExecutionResult};
use mgo_types::effects::TransactionEffects as NativeTransactionEffects;
use mgo_types::transaction::TransactionData as NativeTransactionData;
...
impl TryFrom<MgoExecutionResult> for DryRunEffect {
    type Error = crate::error::Error;

    fn try_from(result: MgoExecutionResult) -> Result<Self, Self::Error> {
