...
use super::{big_int::BigInt, move_type::MoveType, mgo_address::MgoAddress};
...
pub(crate) struct Balance {
    /// Coin type for the balance, such as 0x2::mgo::MGO
...
fn balance_query(address: MgoAddress, coin_type: Option<TypeTag>, lhs: i64, rhs: i64) -> RawQuery {
...
/// `RawQuery`.
fn filter(mut query: RawQuery, owner: MgoAddress, coin_type: Option<TypeTag>) -> RawQuery {
