...
use async_graphql::*;
use mgo_types::mgo_system_state::mgo_system_state_summary::MgoSystemStateSummary as NativeSystemStateSummary;
...
impl SystemStateSummary {
    /// MGO set aside to account for objects stored on-chain, at the start of the epoch.
    ...
    /// The value of the `version` field of `0x5`, the `0x3::mgo::MgoSystemState` object.  This
