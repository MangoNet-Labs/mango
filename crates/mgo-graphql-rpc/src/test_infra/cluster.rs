...
use mgo_graphql_rpc_client::simple_client::SimpleClient;
use mgo_indexer::errors::IndexerError;
pub use mgo_indexer::processors_v2::objects_snapshot_processor::SnapshotLagConfig;
use mgo_indexer::store::indexer_store_v2::IndexerStoreV2;
use mgo_indexer::store::PgIndexerStoreV2;
use mgo_indexer::test_utils::force_delete_database;
use mgo_indexer::test_utils::start_test_indexer_v2;
use mgo_indexer::test_utils::start_test_indexer_v2_impl;
use mgo_indexer::test_utils::ReaderWriterConfig;
...
/// Takes in a simulated instantiation of a Mgo blockchain and builds a cluster around it. This
...
pub async fn serve_executor(
    ...
    let executor_server_handle = tokio::spawn(async move {
        mgo_rest_api::start_service(executor_server_url, executor, Some("/rest".to_owned())).await;
    });
