...
pub(crate) enum FunctionalGroup {
    ...
    /// MgoNS name and reverse name look-up.
    NameService,
...
fn functional_groups() -> &'static BTreeMap<(&'static str, &'static str), FunctionalGroup> {
    ...
    static GROUPS: Lazy<BTreeMap<(&str, &str), FunctionalGroup>> = Lazy::new(|| {
        BTreeMap::from_iter([
            ...
            (("Address", "defaultMgonsName"), G::NameService),
            (("Address", "mgonsRegistrations"), G::NameService),
            ...
            (("Query", "resolveMgonsAddress"), G::NameService),
