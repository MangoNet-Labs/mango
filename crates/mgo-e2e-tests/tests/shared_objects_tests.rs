...
use mgo_macros::{register_fail_point_async, sim_test};
...
use mgo_types::execution_status::{CommandArgumentError, ExecutionFailureStatus, ExecutionStatus};
use mgo_types::messages_grpc::{LayoutGenerationOption, ObjectInfoRequest};
use mgo_types::transaction::{CallArg, ObjectArg};
use test_cluster::TestClusterBuilder;
use tokio::time::sleep;

/// Send a simple shared object transaction to Mgo and ensures the client gets back a response.
#[sim_test]
...
/// End-to-end shared transaction test for a Mgo validator. It does not test the client or wallet,
/// but tests the end-to-end flow from Mgo to consensus.
#[sim_test]
