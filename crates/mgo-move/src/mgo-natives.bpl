...
{%- for instance in mgo_event_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native Mgo event implementation for object type `{{instance.suffix}}`
...
{%- for instance in mgo_types_instances %}

{%- set S = "'" ~ instance.suffix ~ "'" -%}
{%- set T = instance.name -%}

// ----------------------------------------------------------------------------------
// Native Mgo types implementation for object type `{{instance.suffix}}`
...
// ----------------------------------------------------------------------------------
// Native Mgo prover implementation for object type `{{instance.suffix}}`
