...
module Test_DepDepV1::DepDepM1 {
    ...
    struct Obj has key, store { id: mgo::object::UID, v: u64 }

    public fun foo(ctx: &mut mgo::tx_context::TxContext) {
        mgo::transfer::share_object(Obj { id: mgo::object::new(ctx), v: 42 })
    }
}
...
module Test_DepDepV2::DepDepM1 {
    ...
    public fun foo(ctx: &mut mgo::tx_context::TxContext) {
        mgo::transfer::share_object(Obj { id: mgo::object::new(ctx), v: 7 })
    }
}
...
module Test_DepDepV3::DepDepM1 {
    ...
    public fun foo(ctx: &mut mgo::tx_context::TxContext) {
        mgo::transfer::share_object(Obj { id: mgo::object::new(ctx), v: 0 })
    }
}
...
module Test_DepV1::DepM1 {
    ...
    public fun bar(ctx: &mut mgo::tx_context::TxContext) { DepDepM1::foo(ctx) }
}
...
module Test_V1::M1 {
    ...
    public entry fun baz(ctx: &mut mgo::tx_context::TxContext) { DepM1::bar(ctx) }
}
