...
module Test_DepV1::DepM1 {
    ...
    struct DepObj has key, store { id: mgo::object::UID, v: u64 }

    public fun foo(ctx: &mut mgo::tx_context::TxContext) {
        mgo::transfer::share_object(DepObj { id: mgo::object::new(ctx), v: 42 });
    }
...
module Test_DepV2::DepM1 {
    ...
    public fun foo(ctx: &mut mgo::tx_context::TxContext) {
        mgo::transfer::share_object(DepObj { id: mgo::object::new(ctx), v: 7 });
    }
...
module Test_V1::M1 {
    ...
    public entry fun bar(ctx: &mut mgo::tx_context::TxContext) {
        DepM1::foo(ctx);
    }
