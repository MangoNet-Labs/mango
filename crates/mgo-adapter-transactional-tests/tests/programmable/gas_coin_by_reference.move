...
//> test::m1::t1<mgo::coin::Coin<mgo::mgo::MGO>>(Gas)

//# programmable --sender A
//> test::m1::t2<mgo::coin::Coin<mgo::mgo::MGO>>(Gas)

//# programmable --sender A
//> test::m1::t2<mgo::coin::Coin<mgo::mgo::MGO>>(Gas)

//# programmable --sender A
//> test::m1::t4<mgo::coin::Coin<mgo::mgo::MGO>>(Gas)

//# programmable --sender A
//> test::m1::t5<mgo::coin::Coin<mgo::mgo::MGO>>(Gas)

//# programmable --sender A
//> test::m1::t6<mgo::coin::Coin<mgo::mgo::MGO>>(Gas)
