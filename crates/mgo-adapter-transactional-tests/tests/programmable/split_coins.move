...
module test::m1 {
    ...
    public fun transfer(v: vector<coin::Coin<mgo::mgo::MGO>>, r: address) {
...
//# run mgo::pay::split_and_transfer --type-args mgo::mgo::MGO --args object(2,0) 1000 @A --sender A
...
//> 0: test::m1::ret_one_amount();
//> 1: SplitCoins(Input(0), [Result(0), Input(1)]);
//> 2: MakeMoveVec<mgo::coin::Coin<mgo::mgo::MGO>>([NestedResult(1,0), NestedResult(1,1)]);
