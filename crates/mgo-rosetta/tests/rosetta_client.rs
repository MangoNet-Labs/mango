...
use mgo_rosetta::types::{
    ...
    SignatureType, SubAccount, SubAccountType, MgoEnv, TransactionIdentifierResponse,
};
use mgo_rosetta::{RosettaOfflineServer, RosettaOnlineServer};
...
pub async fn start_rosetta_test_server(
    ...
    let online_server = RosettaOnlineServer::new(MgoEnv::LocalNet, client);
    let offline_server = RosettaOfflineServer::new(MgoEnv::LocalNet);
            ...
            .call(
                ...
                &ConstructionCombineRequest {
                    ...
                    signatures: vec![Signature {
                        ...
                        hex_bytes: Hex::from_bytes(MgoSignature::signature_bytes(&signature)),
                    }],
                },
            )
            .await;
