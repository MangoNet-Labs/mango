...
use crate::types::{BlockHash, OperationType, PublicKey, MgoEnv};
...
/// Mgo-Rosetta specific error types.
/// This contains all the errors returns by the mgo-rosetta server.
...
pub enum Error {
    ...
    #[error(transparent)]
    MgoRpcError(#[from] mgo_sdk::error::Error),
    #[error(transparent)]
