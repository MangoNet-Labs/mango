...
use mgo_sdk::rpc_types::Checkpoint;
...
pub struct OnlineServerContext {
    pub client: MgoClient,
    block_provider: Arc<dyn BlockProvider + Send + Sync>,
}

impl OnlineServerContext {
    pub fn new(client: MgoClient, block_provider: Arc<dyn BlockProvider + Send + Sync>) -> Self {
        Self {
            client,
            block_provider,
        }
...
impl CheckpointBlockProvider {
    pub fn new(client: MgoClient) -> Self {
        Self { client }
    }
