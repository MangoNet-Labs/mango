...
use mango_metrics::init_metrics;
...
#[derive(Clone)]
pub struct MgoTransactionBlockResponseBuilder<'a> {
    response: MgoTransactionBlockResponse,
    full_response: &'a MgoTransactionBlockResponse,
}

impl<'a> MgoTransactionBlockResponseBuilder<'a> {
    pub fn new(full_response: &'a MgoTransactionBlockResponse) -> Self {
        Self {
            response: MgoTransactionBlockResponse::default(),
            full_response,
        }
    }

    pub fn with_input(mut self) -> Self {
        self.response = MgoTransactionBlockResponse {
    ...
    pub fn build(self) -> MgoTransactionBlockResponse {
