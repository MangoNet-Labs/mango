...
use mgo_types::base_types::{EpochId, ObjectID, MgoAddress};
...
impl From<MgoSystemStateSummary> for DBSystemStateSummary {
    fn from(s: MgoSystemStateSummary) -> Self {
        Self {
...
pub struct DBValidatorSummary {
    ...
    pub staking_pool_mgo_balance: i64,
    pub rewards_pool: i64,
    pub pool_token_balance: i64,
    pub pending_stake: i64,
    pub pending_total_mgo_withdraw: i64,
    pub pending_pool_token_withdraw: i64,
    pub exchange_rates_id: String,
    pub exchange_rates_size: i64,
}

impl From<(EpochId, MgoValidatorSummary)> for DBValidatorSummary {
    fn from((epoch, v): (EpochId, MgoValidatorSummary)) -> Self {
        Self {
            epoch: epoch as i64,
            mgo_address: v.mgo_address.to_string(),
            ...
            staking_pool_mgo_balance: v.staking_pool_mgo_balance as i64,
            rewards_pool: v.rewards_pool as i64,
            pool_token_balance: v.pool_token_balance as i64,
            pending_stake: v.pending_stake as i64,
            pending_total_mgo_withdraw: v.pending_total_mgo_withdraw as i64,
...
impl TryFrom<DBValidatorSummary> for MgoValidatorSummary {
    type Error = IndexerError;
    fn try_from(db: DBValidatorSummary) -> Result<MgoValidatorSummary, Self::Error> {
        Ok(MgoValidatorSummary {
            mgo_address: MgoAddress::from_str(&db.mgo_address)?,
            ...
            staking_pool_mgo_balance: db.staking_pool_mgo_balance as u64,
            rewards_pool: db.rewards_pool as u64,
            pool_token_balance: db.pool_token_balance as u64,
            pending_stake: db.pending_stake as u64,
            pending_total_mgo_withdraw: db.pending_total_mgo_withdraw as u64,
