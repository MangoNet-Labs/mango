...
use mgo_json_rpc_types::{MgoObjectData, MgoObjectRef, MgoRawData};
use mgo_types::digests::TransactionDigest;
use mgo_types::move_package::MovePackage;
use mgo_types::object::{Data, MoveObject, ObjectRead, Owner};
use mgo_types::{
    base_types::{ObjectID, ObjectRef, ObjectType, SequenceNumber, MgoAddress},
    storage::WriteKind,
};
...
impl Object {
    pub fn new(
        ...
        checkpoint: u64,
        kind: WriteKind,
        object: &mgo_types::object::Object,
    ) -> Self {
...
impl TryFrom<Object> for mgo_types::object::Object {
    ...
    fn try_from(o: Object) -> Result<Self, Self::Error> {
        ...
        let owner = match o.owner_type {
            OwnerType::AddressOwner => Owner::AddressOwner(MgoAddress::from_str(
                &o.owner_address.expect("Owner address should not be empty."),
            )?),
            OwnerType::ObjectOwner => Owner::ObjectOwner(MgoAddress::from_str(
                &o.owner_address.expect("Owner address should not be empty."),
            )?),
