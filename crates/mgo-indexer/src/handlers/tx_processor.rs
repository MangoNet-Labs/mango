...
use mgo_json_rpc::get_balance_changes_from_effect;
use mgo_json_rpc::get_object_changes;
use mgo_json_rpc::ObjectProvider;
...
use mgo_types::transaction::{TransactionData, TransactionDataAPI};
use tracing::debug;
...
impl TxChangesProcessor {
    ...
    pub(crate) async fn get_changes(
        ...
        Vec<mgo_json_rpc_types::BalanceChange>,
...
// This is a struct that is used to extract MgoSystemState and its dynamic children
...
impl<'a> mgo_types::storage::ObjectStore for EpochEndIndexingObjectStore<'a> {
    fn get_object(
        &self,
        object_id: &ObjectID,
