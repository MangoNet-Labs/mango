...
use mgo_json_rpc_types::{
    ...
    NetworkMetrics, MgoObjectData, MgoObjectDataFilter, MgoTransactionBlockEffects,
    MgoTransactionBlockResponse, MgoTransactionBlockResponseOptions,
};
use mgo_types::base_types::{EpochId, ObjectID, SequenceNumber, MgoAddress, VersionNumber};
use mgo_types::digests::{CheckpointDigest, TransactionDigest};
...
pub struct CheckpointTxData {
    ...
    pub system_state_objects: Vec<mgo_types::object::Object>,
}

// CheckpointTxData can ONLY be used as a ObjectStore
// for MgoSystemState Object.
...
pub struct CheckpointObjectData {
    ...
    // MgoAddress is tx sender
    pub transactions: Vec<(TransactionDigest, MgoTransactionBlockEffects)>,
    pub transaction_senders: HashMap<TransactionDigest, MgoAddress>,
    pub changed_objects: Vec<(ObjectStatus, MgoObjectData)>,
}
