...
impl IndexedCheckpoint {
    pub fn from_mgo_checkpoint(
        checkpoint: &mgo_types::messages_checkpoint::CertifiedCheckpointSummary,
        contents: &mgo_types::messages_checkpoint::CheckpointContents,
...
impl IndexedEpochInfo {
    pub fn from_new_system_state_summary(
        new_system_state_summary: MgoSystemStateSummary,
...
pub fn owner_to_owner_info(owner: &Owner) -> (OwnerType, Option<MgoAddress>) {
    match owner {
...
pub struct IndexedObject {
    ...
    pub owner_id: Option<MgoAddress>,
    pub object: Object,
...
pub struct IndexedTransaction {
    ...
    pub balance_change: Vec<mgo_json_rpc_types::BalanceChange>,
    pub events: Vec<mgo_types::event::Event>,
