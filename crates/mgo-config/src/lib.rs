...
const MGO_DIR: &str = ".mgo";
pub const MGO_CONFIG_DIR: &str = "mgo_config";
pub const MGO_NETWORK_CONFIG: &str = "network.yaml";
pub const MGO_FULLNODE_CONFIG: &str = "fullnode.yaml";
pub const MGO_CLIENT_CONFIG: &str = "client.yaml";
pub const MGO_KEYSTORE_FILENAME: &str = "mgo.keystore";
pub const MGO_KEYSTORE_ALIASES_FILENAME: &str = "mgo.aliases";
pub const MGO_BENCHMARK_GENESIS_GAS_KEYSTORE_FILENAME: &str = "benchmark.keystore";
pub const MGO_GENESIS_FILENAME: &str = "genesis.blob";
pub const MGO_DEV_NET_URL: &str = "https://fullnode.devnet.mangonetwork.io:443";

pub const AUTHORITIES_DB_NAME: &str = "authorities_db";
pub const CONSENSUS_DB_NAME: &str = "consensus_db";
pub const FULL_NODE_DB_PATH: &str = "full_node_db";

pub fn mgo_config_dir() -> Result<PathBuf, anyhow::Error> {
    match std::env::var_os("MGO_CONFIG_DIR") {
        Some(config_env) => Ok(config_env.into()),
        None => match dirs::home_dir() {
            Some(v) => Ok(v.join(MGO_DIR).join(MGO_CONFIG_DIR)),
