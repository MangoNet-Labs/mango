...
pub const MGO_VALIDATOR_SERVER_NAME: &str = "mgo";
...
mod tests {
    ...
    fn verify_allowall() {
        ...
        let random_cert_bob =
            SelfSignedCertificate::new(allowed.private(), MGO_VALIDATOR_SERVER_NAME);
        let random_cert_alice =
            SelfSignedCertificate::new(disallowed.private(), MGO_VALIDATOR_SERVER_NAME);
    ...
    fn verify_hashset() {
        ...
        let allowed_cert = SelfSignedCertificate::new(allowed.private(), MGO_VALIDATOR_SERVER_NAME);
    ...
    fn invalid_server_name() {
        ...
        let cert = SelfSignedCertificate::new(keypair.private(), "not-mgo");
        ...
        // Allowed public key but the server-name in the cert is not the required "mgo"
        verifier
            .verify_client_cert(
    ...
    async fn axum_acceptor() {
        ...
        let client_certificate =
            SelfSignedCertificate::new(client_keypair.private(), MGO_VALIDATOR_SERVER_NAME);
