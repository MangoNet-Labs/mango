...
use mgo_types::transaction::{Argument, CallArg, Command, ProgrammableTransaction};
...
prop_compose! {
    pub fn gen_many_input_match(recipient: MgoAddress, package: ObjectID, cap: ObjectRef)
