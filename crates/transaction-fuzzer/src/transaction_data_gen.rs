...
pub fn gen_gas_data(sender: MgoAddress) -> impl Strategy<Value = GasData> {
    (
...
pub fn transaction_data_gen(sender: MgoAddress) -> impl Strategy<Value = TransactionData> {
...
{
    pub fn new(sender: MgoAddress) -> Self {
        Self {
            kind: None,
            sender,
            gas_data: None,
