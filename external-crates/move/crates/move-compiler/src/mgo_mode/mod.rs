...
pub const MGO_ADDR_NAME: Symbol = symbol!("mgo");
...
pub const MGO_MODULE_NAME: Symbol = symbol!("mgo");
pub const MGO_OTW_NAME: Symbol = symbol!("MGO");

pub const MGO_SYSTEM_ADDR_NAME: Symbol = symbol!("mgo_system");
pub const MGO_SYSTEM_MODULE_NAME: Symbol = symbol!("mgo_system");
pub const MGO_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const MGO_CLOCK_CREATE: Symbol = symbol!("create");
...
pub const MGO_DIAG_PREFIX: &str = "Mgo ";
