...
use super::{
    ...
    RECEIVE_FUN, SHARE_FUN, MGO_PKG_NAME, TRANSFER_FUN, TRANSFER_MOD_NAME,
};

const PRIVATE_OBJ_FUNCTIONS: &[(&str, &str, &str)] = &[
    (MGO_PKG_NAME, TRANSFER_MOD_NAME, TRANSFER_FUN),
    (MGO_PKG_NAME, TRANSFER_MOD_NAME, SHARE_FUN),
    (MGO_PKG_NAME, TRANSFER_MOD_NAME, FREEZE_FUN),
    (MGO_PKG_NAME, TRANSFER_MOD_NAME, RECEIVE_FUN),
];
