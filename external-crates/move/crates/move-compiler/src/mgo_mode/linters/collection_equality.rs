...
//! This analysis flags situations when instances of a mgo::table::Table or mgo::table_vec::TableVec
//! or mgo::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use super::{
    ...
    OBJECT_BAG_STRUCT_NAME, OBJECT_TABLE_MOD_NAME, OBJECT_TABLE_STRUCT_NAME, MGO_PKG_NAME,
...
const COLLECTION_TYPES: &[(&str, &str, &str)] = &[
    (MGO_PKG_NAME, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (MGO_PKG_NAME, OBJECT_BAG_MOD_NAME, OBJECT_BAG_STRUCT_NAME),
    (MGO_PKG_NAME, TABLE_MOD_NAME, TABLE_STRUCT_NAME),
    (
        MGO_PKG_NAME,
    ...
    (MGO_PKG_NAME, TABLE_VEC_MOD_NAME, TABLE_VEC_STRUCT_NAME),
    (MGO_PKG_NAME, VEC_MAP_MOD_NAME, VEC_MAP_STRUCT_NAME),
    (MGO_PKG_NAME, VEC_SET_MOD_NAME, VEC_SET_STRUCT_NAME),
];
