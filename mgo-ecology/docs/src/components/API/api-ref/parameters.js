...
export const Parameter = (props) => {
  ...
  return (
    <>
      <div className="grid grid-cols-6 ml-4 odd:bg-mgo-ghost-white dark:odd:bg-mgo-ghost-dark rounded-lg">
    ...
    <div className="border-b mb-8">
      {hasParams && (
        <div className="grid grid-cols-6 ml-4">
          ...
          <div className="p-2 bg-mgo-blue dark:bg-mgo-blue-dark text-mgo-gray-95 dark:text-mgo-gray-50 text-mgo-gray-35 font-bold">
            Required
          </div>
          <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-mgo-blue dark:bg-mgo-blue-dark text-mgo-gray-95 dark:text-mgo-gray-50 text-mgo-gray-35 font-bold">
            Description
          </div>
        </div>
      )}
