...
export default function chart2() {
  const initCharts = () => {
    chartDom = document.getElementById('main2-chart')!;
  ...
  const getCharts = async () => {
    const res = await $clientGet(`/transactionBlocks?page=1&limit=100`)
  ...
  return (
    <div className="w-full h-[270px]" id="main2-chart"></div>
  )
}
