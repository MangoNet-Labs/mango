...
module basics::object {
    ...
    /// A custom mgo object. Every object must have the `key` attribute
    /// (indicating that it is allowed to be a key in the mgo global object
    /// pool), and must have a field `id: UID` corresponding to its mgo ObjId.
    ...
    /// Example of an entrypoint function to be embedded in a Mgo
    ...
    ///
    /// A Mgo transaction must declare the ID's of each object it will
