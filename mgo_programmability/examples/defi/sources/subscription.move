...
///
///
/// The problem that illustrates usage of this module might be common in Mgo. To
/// get to it, we need to provide some background:
///
/// - Shared object transactions in Mgo require consensus; and for each shared
...
module defi::dev_pass {
    ...
    /// Burn a subscription without checking for number of uses. Allows Mgo storage refunds
