...
module.exports = {
	...
	rules: {
		...
		'header/header': [
			2,
			'line',
			[' Copyright (c) MangoNetwork Labs, Inc.', ' SPDX-License-Identifier: Apache-2.0'],
		],
	...
	overrides: [
		...
		{
			files: ['sdk/ledgerjs-hw-app-mgo/**/*', 'apps/wallet/**/*'],
			rules: {
				// ledgerjs-hw-app-mgo and wallet use Buffer
