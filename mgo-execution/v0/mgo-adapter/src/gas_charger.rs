...
pub mod checked {
    ...
    use crate::mgo_types::gas::MgoGasStatusAPI;
    use crate::temporary_store::TemporaryStore;
    use mgo_protocol_config::ProtocolConfig;
    use mgo_types::gas::{deduct_gas, GasCostSummary, MgoGasStatus};
    use mgo_types::gas_model::gas_predicates::dont_charge_budget_on_storage_oog;
    use mgo_types::{
    ...
    impl GasCharger {
        ...
        pub fn new_unmetered(tx_digest: TransactionDigest) -> Self {
            Self {
                ...
                gas_coins: vec![],
                smashed_gas_coin: None,
                gas_status: MgoGasStatus::new_unmetered(),
            }
        }
        ...
        pub fn into_gas_status(self) -> MgoGasStatus {
            self.gas_status
        }
        ...
        pub fn charge_input_objects(
            ...
            let total_size = temporary_store
                .objects()
                .iter()
                // don't charge for loading Mgo Framework or Move stdlib
