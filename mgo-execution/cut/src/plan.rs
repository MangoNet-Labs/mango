...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let mgo_execution = root.join("mgo-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&mgo_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/mgo-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "mgo-adapter-latest".to_string(),
                "mgo-execution-cut".to_string(),
                "mgo-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/mgo-execution/cut-cut",
                    "$PATH/mgo-execution/cut-move-core-types",
                    "$PATH/mgo-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/mgo-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "mgo-adapter-latest": CutPackage {
                        dst_name: "mgo-adapter-feature",
                        src_path: "$PATH/mgo-execution/latest/mgo-adapter",
                        dst_path: "$PATH/mgo-execution/exec-cut/mgo-adapter",
                        ws_state: Member,
                    },
                    "mgo-execution-cut": CutPackage {
                        dst_name: "mgo-execution-cut-feature",
                        src_path: "$PATH/mgo-execution/cut",
                        dst_path: "$PATH/mgo-execution/cut-cut",
                        ws_state: Member,
                    },
                    "mgo-verifier-latest": CutPackage {
                        dst_name: "mgo-verifier-feature",
                        src_path: "$PATH/mgo-execution/latest/mgo-verifier",
                        dst_path: "$PATH/mgo-execution/exec-cut/mgo-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   mgo-adapter-feature
                     mgo-execution/exec-cut/mgo-adapter
               from: mgo-adapter-latest
                     mgo-execution/latest/mgo-adapter
             - to:   mgo-execution-cut-feature
                     mgo-execution/cut-cut
               from: mgo-execution-cut
                     mgo-execution/cut
             - to:   mgo-verifier-feature
                     mgo-execution/exec-cut/mgo-verifier
               from: mgo-verifier-latest
                     mgo-execution/latest/mgo-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     mgo-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/mgo-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/mgo-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "mgo-adapter-latest": CutPackage {
                        dst_name: "mgo-adapter-feature",
                        src_path: "$PATH/mgo-execution/latest/mgo-adapter",
                        dst_path: "$PATH/mgo-execution/feature/mgo-adapter",
                        ws_state: Member,
                    },
                    "mgo-execution-cut": CutPackage {
                        dst_name: "mgo-execution-cut-feature",
                        src_path: "$PATH/mgo-execution/cut",
                        dst_path: "$PATH/mgo-execution/feature/cut",
                        ws_state: Member,
                    },
                    "mgo-verifier-latest": CutPackage {
                        dst_name: "mgo-verifier-feature",
                        src_path: "$PATH/mgo-execution/latest/mgo-verifier",
                        dst_path: "$PATH/mgo-execution/feature/mgo-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
