...
struct MgoVerifierMeterBounds {
    name: String,
    ticks: u128,
    max_ticks: Option<u128>,
}

impl MgoVerifierMeterBounds {
...
pub struct MgoVerifierMeter {
    transaction_bounds: MgoVerifierMeterBounds,
    package_bounds: MgoVerifierMeterBounds,
    module_bounds: MgoVerifierMeterBounds,
    function_bounds: MgoVerifierMeterBounds,
}

impl MgoVerifierMeter {
    ...
    fn get_bounds_mut(&mut self, scope: Scope) -> &mut MgoVerifierMeterBounds {
        match scope {
    ...
    fn get_bounds(&self, scope: Scope) -> &MgoVerifierMeterBounds {
        match scope {
...
impl Meter for MgoVerifierMeter {
