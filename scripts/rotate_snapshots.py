...
for example, /opt/mgo, it assumes snapshots are staged in /opt/mgo/snapshots,
and all symlinks to said snapshots are contained under /opt/mgo/instances. It will delete all snapshots that are not
...
def usage():
    ...
    print(
        f'   --dir=<mgo-base-dir>   Base directory for mgo. Must contain /snapshots and /instances dirs')
